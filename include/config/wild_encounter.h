...
#define WE_OWE_FEEBAS_SPOTS                     FALSE   // TRUEの場合、ヒンバスが釣れる可能性のあるあらゆる地点で、ヒンバスのOWE（フィールド上のポケモン）が出現し得ます。
...
#define WE_OWE_PREVENT_SHINY_DESPAWN            FALSE   // TRUEの場合、プレイヤーと同じマップ上にいる限り、画面外に出ても色違いのOWEは消滅せず、またWE_OWE_SPAWN_REPLACEMENTがTRUEであっても置き換えられません。
