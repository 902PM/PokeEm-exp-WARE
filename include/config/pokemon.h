...
#define P_CAN_FORGET_HIDDEN_MOVE         FALSE       // TRUEの場合、ポケモンは秘伝技であっても、忘れることができます。
...
#define P_SHOW_DYNAMIC_TYPES             FALSE       // TRUEの場合、めざめるパワーのようなタイプが変化するすべての技について、原作のように一部の技だけでなく、バ​​トル画面やステータス画面で現在のタイプが反映されるようになります。
