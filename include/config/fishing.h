...
#define I_FISHING_MINIGAME          GEN_LATEST // 各世代において、ポケモンを釣り上げた後の「リールを巻く」操作にはそれぞれ異なる方式が採用されています。注：現時点で実装されているのは、第1・2世代および第3世代のミニゲームのみです。
...
#define I_FISHING_FOLLOWER_BOOST    FALSE      // HGSSでは、現在連れ歩いているポケモンのなつき度に応じて、釣りでポケモンがヒットする確率が上がります。
