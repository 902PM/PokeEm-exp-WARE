...
static const struct ListMenuItem sVolatileStatusListItems[] =
{
    ...
    {COMPOUND_STRING("くろいまなざし"),   VOLATILE_ESCAPE_PREVENTION},
    {COMPOUND_STRING("のろい"),             VOLATILE_CURSED},
...
{
    {COMPOUND_STRING("HPを ひょうじ"),       VARIOUS_SHOW_HP},
    {COMPOUND_STRING("みがわりのHP"), VARIOUS_SUBSTITUTE_HP},
...
{
    [HOLD_EFFECT_NONE]             = COMPOUND_STRING("こうかなし"),
    [HOLD_EFFECT_RESTORE_HP]       = COMPOUND_STRING("HP かいふく"),
    [HOLD_EFFECT_CURE_PAR]         = COMPOUND_STRING("マヒ かいふく"),
    [HOLD_EFFECT_CURE_SLP]         = COMPOUND_STRING("ねむり かいふく"),
    [HOLD_EFFECT_CURE_PSN]         = COMPOUND_STRING("どく かいふく"),
    [HOLD_EFFECT_CURE_BRN]         = COMPOUND_STRING("やけど かいふく"),
    [HOLD_EFFECT_CURE_FRZ]         = COMPOUND_STRING("こおり かいふく"),
    [HOLD_EFFECT_RESTORE_PP]       = COMPOUND_STRING("PP かいふく"),
    [HOLD_EFFECT_CURE_CONFUSION]   = COMPOUND_STRING("こんらん かいふく"),
    [HOLD_EFFECT_CURE_STATUS]      = COMPOUND_STRING("ステータス リセット"),
    [HOLD_EFFECT_CONFUSE_FLAVOR]   = COMPOUND_STRING("こんらんのみ"),
    [HOLD_EFFECT_ATTACK_UP]        = COMPOUND_STRING("こうげきアップ"),
    [HOLD_EFFECT_DEFENSE_UP]       = COMPOUND_STRING("ぼうぎょアップ"),
    [HOLD_EFFECT_SPEED_UP]         = COMPOUND_STRING("すばやさアップ"),
    [HOLD_EFFECT_SP_ATTACK_UP]     = COMPOUND_STRING("とくこうアップ"),
    [HOLD_EFFECT_SP_DEFENSE_UP]    = COMPOUND_STRING("とくぼうアップ"),
    [HOLD_EFFECT_CRITICAL_UP]      = COMPOUND_STRING("クリティカルアップ"),
    [HOLD_EFFECT_RANDOM_STAT_UP]   = COMPOUND_STRING("ランダムステータスアップ"),
    [HOLD_EFFECT_EVASION_UP]       = COMPOUND_STRING("かいひりつ アップ"),
    [HOLD_EFFECT_WHITE_HERB]       = COMPOUND_STRING("しろいハーブ"),
    [HOLD_EFFECT_MACHO_BRACE]      = COMPOUND_STRING("きょうせいギプス"),
    [HOLD_EFFECT_EXP_SHARE]        = COMPOUND_STRING("がくしゅうそうち"),
    [HOLD_EFFECT_QUICK_CLAW]       = COMPOUND_STRING("せんせいのツメ"),
    [HOLD_EFFECT_FRIENDSHIP_UP]    = COMPOUND_STRING("なかよしアップ"),
    [HOLD_EFFECT_MENTAL_HERB]      = COMPOUND_STRING("メンタルハーブ"),
    [HOLD_EFFECT_CHOICE_BAND]      = COMPOUND_STRING("こだわりハチマキ"),
    [HOLD_EFFECT_FLINCH]           = COMPOUND_STRING("ひるみ"),
    [HOLD_EFFECT_DOUBLE_PRIZE]     = COMPOUND_STRING("おまもりこばん"),
    [HOLD_EFFECT_REPEL]            = COMPOUND_STRING("スプレー"),
    [HOLD_EFFECT_SOUL_DEW]         = COMPOUND_STRING("こころのしずく"),
    [HOLD_EFFECT_DEEP_SEA_TOOTH]   = COMPOUND_STRING("しんかいのキバ"),
    [HOLD_EFFECT_DEEP_SEA_SCALE]   = COMPOUND_STRING("しんかいのウロコ"),
    [HOLD_EFFECT_CAN_ALWAYS_RUN]   = COMPOUND_STRING("ランニングシューズ"),
    [HOLD_EFFECT_PREVENT_EVOLVE]   = COMPOUND_STRING("かわらずのいし"),
    [HOLD_EFFECT_FOCUS_BAND]       = COMPOUND_STRING("きあいのハチマキ"),
    [HOLD_EFFECT_LUCKY_EGG]        = COMPOUND_STRING("しあわせのタマゴ"),
    [HOLD_EFFECT_SCOPE_LENS]       = COMPOUND_STRING("ピントレンズ"),
    [HOLD_EFFECT_LEFTOVERS]        = COMPOUND_STRING("たべのこし"),
    [HOLD_EFFECT_LIGHT_BALL]       = COMPOUND_STRING("でんきだま"),
    [HOLD_EFFECT_TYPE_POWER]       = COMPOUND_STRING("タイプわざ きょうか"),
    [HOLD_EFFECT_SHELL_BELL]       = COMPOUND_STRING("かいがらのすず"),
    [HOLD_EFFECT_LUCKY_PUNCH]      = COMPOUND_STRING("ラッキーパンチ"),
    [HOLD_EFFECT_METAL_POWDER]     = COMPOUND_STRING("メタルパウダー"),
    [HOLD_EFFECT_THICK_CLUB]       = COMPOUND_STRING("ふといホネ"),
    [HOLD_EFFECT_LEEK]             = COMPOUND_STRING("ながねぎ"),
    [HOLD_EFFECT_CHOICE_SCARF]     = COMPOUND_STRING("こだわりスカーフ"),
    [HOLD_EFFECT_CHOICE_SPECS]     = COMPOUND_STRING("こだわりメガネ"),
    [HOLD_EFFECT_DAMP_ROCK]        = COMPOUND_STRING("しめったいわ"),
    [HOLD_EFFECT_GRIP_CLAW]        = COMPOUND_STRING("ねばりのかぎづめ"),
    [HOLD_EFFECT_HEAT_ROCK]        = COMPOUND_STRING("あついいわ"),
    [HOLD_EFFECT_ICY_ROCK]         = COMPOUND_STRING("つめたいいわ"),
    [HOLD_EFFECT_LIGHT_CLAY]       = COMPOUND_STRING("ひかりのねんど"),
    [HOLD_EFFECT_SMOOTH_ROCK]      = COMPOUND_STRING("さらさらいわ"),
    [HOLD_EFFECT_POWER_HERB]       = COMPOUND_STRING("パワフルハーブ"),
    [HOLD_EFFECT_BIG_ROOT]         = COMPOUND_STRING("おおきなねっこ"),
    [HOLD_EFFECT_EXPERT_BELT]      = COMPOUND_STRING("たつじんのおび"),
    [HOLD_EFFECT_LIFE_ORB]         = COMPOUND_STRING("いのちのたま"),
    [HOLD_EFFECT_METRONOME]        = COMPOUND_STRING("メトロノーム"),
    [HOLD_EFFECT_MUSCLE_BAND]      = COMPOUND_STRING("ちからのハチマキ"),
    [HOLD_EFFECT_WIDE_LENS]        = COMPOUND_STRING("こうかくレンズ"),
    [HOLD_EFFECT_WISE_GLASSES]     = COMPOUND_STRING("ものしりメガネ"),
    [HOLD_EFFECT_ZOOM_LENS]        = COMPOUND_STRING("フォーカスレンズ"),
    [HOLD_EFFECT_LAGGING_TAIL]     = COMPOUND_STRING("こうこうのしっぽ"),
    [HOLD_EFFECT_FOCUS_SASH]       = COMPOUND_STRING("きあいのタスキ"),
    [HOLD_EFFECT_FLAME_ORB]        = COMPOUND_STRING("かえんだま"),
    [HOLD_EFFECT_TOXIC_ORB]        = COMPOUND_STRING("どくどくだま"),
    [HOLD_EFFECT_STICKY_BARB]      = COMPOUND_STRING("くっつきバリ"),
    [HOLD_EFFECT_IRON_BALL]        = COMPOUND_STRING("くろいてっきゅう"),
    [HOLD_EFFECT_BLACK_SLUDGE]     = COMPOUND_STRING("くろいヘドロ"),
    [HOLD_EFFECT_DESTINY_KNOT]     = COMPOUND_STRING("あかいいと"),
    [HOLD_EFFECT_SHED_SHELL]       = COMPOUND_STRING("きれいなぬけがら"),
    [HOLD_EFFECT_QUICK_POWDER]     = COMPOUND_STRING("スピードパウダー"),
    [HOLD_EFFECT_ADAMANT_ORB]      = COMPOUND_STRING("こんごうだま"),
    [HOLD_EFFECT_LUSTROUS_ORB]     = COMPOUND_STRING("しらたま"),
    [HOLD_EFFECT_GRISEOUS_ORB]     = COMPOUND_STRING("はっきんだま"),
    [HOLD_EFFECT_ENIGMA_BERRY]     = COMPOUND_STRING("ナゾのみ"),
    [HOLD_EFFECT_RESIST_BERRY]     = COMPOUND_STRING("はんげんのみ"),
    [HOLD_EFFECT_POWER_ITEM]       = COMPOUND_STRING("パワーアップのみ"),
    [HOLD_EFFECT_RESTORE_PCT_HP]   = COMPOUND_STRING("HPをかいふく"),
    [HOLD_EFFECT_MICLE_BERRY]      = COMPOUND_STRING("ミクルのみ"),
    [HOLD_EFFECT_CUSTAP_BERRY]     = COMPOUND_STRING("イバンのみ"),
    [HOLD_EFFECT_JABOCA_BERRY]     = COMPOUND_STRING("ジャポのみ"),
    [HOLD_EFFECT_ROWAP_BERRY]      = COMPOUND_STRING("レンブのみ"),
    [HOLD_EFFECT_KEE_BERRY]        = COMPOUND_STRING("アッキのみ"),
    [HOLD_EFFECT_MARANGA_BERRY]    = COMPOUND_STRING("タラプのみ"),
    [HOLD_EFFECT_PLATE]            = COMPOUND_STRING("プレート"),
    [HOLD_EFFECT_FLOAT_STONE]      = COMPOUND_STRING("かるいし"),
    [HOLD_EFFECT_EVIOLITE]         = COMPOUND_STRING("しんかのきせき"),
    [HOLD_EFFECT_ASSAULT_VEST]     = COMPOUND_STRING("とつげきチョッキ"),
    [HOLD_EFFECT_DRIVE]            = COMPOUND_STRING("カセット"),
    [HOLD_EFFECT_GEMS]             = COMPOUND_STRING("ジュエル"),
    [HOLD_EFFECT_ROCKY_HELMET]     = COMPOUND_STRING("ゴツゴツメット"),
    [HOLD_EFFECT_AIR_BALLOON]      = COMPOUND_STRING("ふうせん"),
    [HOLD_EFFECT_RED_CARD]         = COMPOUND_STRING("レッドカード"),
    [HOLD_EFFECT_RING_TARGET]      = COMPOUND_STRING("ねらいのまと"),
    [HOLD_EFFECT_BINDING_BAND]     = COMPOUND_STRING("しめつけバンド"),
    [HOLD_EFFECT_EJECT_BUTTON]     = COMPOUND_STRING("だっしゅつボタン"),
    [HOLD_EFFECT_ABSORB_BULB]      = COMPOUND_STRING("きゅうこん"),
    [HOLD_EFFECT_CELL_BATTERY]     = COMPOUND_STRING("じゅうでんち"),
    [HOLD_EFFECT_MEGA_STONE]       = COMPOUND_STRING("メガストーン"),
    [HOLD_EFFECT_SAFETY_GOGGLES]   = COMPOUND_STRING("ぼうじんゴーグル"),
    [HOLD_EFFECT_LUMINOUS_MOSS]    = COMPOUND_STRING("ひかりゴケ"),
    [HOLD_EFFECT_SNOWBALL]         = COMPOUND_STRING("ゆきだま"),
    [HOLD_EFFECT_WEAKNESS_POLICY]  = COMPOUND_STRING("じゃくてんほけん"),
    [HOLD_EFFECT_PRIMAL_ORB]       = COMPOUND_STRING("ゲンシカイキ"),
    [HOLD_EFFECT_PROTECTIVE_PADS]  = COMPOUND_STRING("ぼうごパット"),
    [HOLD_EFFECT_TERRAIN_EXTENDER] = COMPOUND_STRING("グランドコート"),
    [HOLD_EFFECT_TERRAIN_SEED]     = COMPOUND_STRING("シード"),
    [HOLD_EFFECT_ADRENALINE_ORB]   = COMPOUND_STRING("ビビリだま"),
    [HOLD_EFFECT_MEMORY]           = COMPOUND_STRING("メモリ"),
    [HOLD_EFFECT_Z_CRYSTAL]        = COMPOUND_STRING("Zクリスタル"),
    [HOLD_EFFECT_UTILITY_UMBRELLA] = COMPOUND_STRING("ばんのうがさ"),
    [HOLD_EFFECT_EJECT_PACK]       = COMPOUND_STRING("だっしゅつパック"),
    [HOLD_EFFECT_ROOM_SERVICE]     = COMPOUND_STRING("ルームサービス"),
    [HOLD_EFFECT_BLUNDER_POLICY]   = COMPOUND_STRING("からぶりほけん"),
    [HOLD_EFFECT_HEAVY_DUTY_BOOTS] = COMPOUND_STRING("あつぞこブーツ"),
    [HOLD_EFFECT_THROAT_SPRAY]     = COMPOUND_STRING("のどスプレー"),
    [HOLD_EFFECT_ABILITY_SHIELD]   = COMPOUND_STRING("とくせいガード"),
    [HOLD_EFFECT_CLEAR_AMULET]     = COMPOUND_STRING("クリアチャーム"),
    [HOLD_EFFECT_MIRROR_HERB]      = COMPOUND_STRING("ものまねハーブ"),
    [HOLD_EFFECT_PUNCHING_GLOVE]   = COMPOUND_STRING("パンチグローブ"),
    [HOLD_EFFECT_COVERT_CLOAK]     = COMPOUND_STRING("おんみつマント"),
    [HOLD_EFFECT_LOADED_DICE]      = COMPOUND_STRING("いかさまダイス"),
    [HOLD_EFFECT_BOOSTER_ENERGY]   = COMPOUND_STRING("ブーストエナジー"),
    [HOLD_EFFECT_OGERPON_MASK]     = COMPOUND_STRING("オーガポンのおめん"),
    [HOLD_EFFECT_BERSERK_GENE]     = COMPOUND_STRING("はかいのいでんし"),
};
