...
static const u8 LandmarkName_MagmaHideout[] = _("マグマだんアジト"); //Unused

static const struct Landmark Landmark_FlowerShop = {COMPOUND_STRING("フラワーショップ"), FLAG_LANDMARK_FLOWER_SHOP};
static const struct Landmark Landmark_PetalburgWoods = {COMPOUND_STRING("トウカのもり"), -1};
static const struct Landmark Landmark_MrBrineysCottage = {COMPOUND_STRING("ハギろうじんのこや"), FLAG_LANDMARK_MR_BRINEY_HOUSE};
static const struct Landmark Landmark_AbandonedShip = {COMPOUND_STRING("すてられぶね"), FLAG_LANDMARK_ABANDONED_SHIP};
static const struct Landmark Landmark_SeashoreHouse = {COMPOUND_STRING("うみのいえ"), FLAG_LANDMARK_SEASHORE_HOUSE};
static const struct Landmark Landmark_SlateportBeach = {COMPOUND_STRING("カイナのすなはま"), -1};
static const struct Landmark Landmark_CyclingRoad = {COMPOUND_STRING("サイクリング ロード"), -1};
static const struct Landmark Landmark_NewMauville = {COMPOUND_STRING("ニューキンセツ"), FLAG_LANDMARK_NEW_MAUVILLE};
static const struct Landmark Landmark_TrickHouse = {COMPOUND_STRING("カラクリやしき"), FLAG_LANDMARK_TRICK_HOUSE};
static const struct Landmark Landmark_OldLadysRestShop = {COMPOUND_STRING("ケンコーばあさん"), FLAG_LANDMARK_OLD_LADY_REST_SHOP};
static const struct Landmark Landmark_Desert = {COMPOUND_STRING("さばく"), -1};
static const struct Landmark Landmark_WinstrateFamily = {COMPOUND_STRING("カチヌキ ファミリー"), FLAG_LANDMARK_WINSTRATE_FAMILY};
static const struct Landmark Landmark_CableCar = {COMPOUND_STRING("ロープウェイのりば"), -1};
static const struct Landmark Landmark_GlassWorkshop = {COMPOUND_STRING("ガラスざいくのみせ"), FLAG_LANDMARK_GLASS_WORKSHOP};
static const struct Landmark Landmark_WeatherInstitute = {COMPOUND_STRING("てんきけんきゅうじょ"), -1};
static const struct Landmark Landmark_MeteorFalls = {COMPOUND_STRING("りゅうせいのたき"), -1};
static const struct Landmark Landmark_TunnelersRestHouse = {COMPOUND_STRING("さぎょういんつめしょ"), FLAG_LANDMARK_TUNNELERS_REST_HOUSE};
static const struct Landmark Landmark_RusturfTunnel = {COMPOUND_STRING("カナシダトンネル"), -1};
static const struct Landmark Landmark_PokemonDayCare = {COMPOUND_STRING("ポケモンそだてや"), FLAG_LANDMARK_POKEMON_DAYCARE};
static const struct Landmark Landmark_SafariZoneEntrance = {COMPOUND_STRING("サファリゾーンいりぐち"), -1};
static const struct Landmark Landmark_MtPyre = {COMPOUND_STRING("おくりびやま"), -1};
static const struct Landmark Landmark_ShoalCave = {COMPOUND_STRING("あさせのほらあな"), -1};
static const struct Landmark Landmark_SeafloorCavern = {COMPOUND_STRING("かいていどうくつ"), FLAG_LANDMARK_SEAFLOOR_CAVERN};
static const struct Landmark Landmark_GraniteCave = {COMPOUND_STRING("いしのどうくつ"), -1};
static const struct Landmark Landmark_OceanCurrent = {COMPOUND_STRING("かいりゅう"), -1};
static const struct Landmark Landmark_LanettesHouse = {COMPOUND_STRING("マユミのいえ"), FLAG_LANDMARK_LANETTES_HOUSE};
static const struct Landmark Landmark_FieryPath = {COMPOUND_STRING("ほのおのぬけみち"), FLAG_LANDMARK_FIERY_PATH};
static const struct Landmark Landmark_JaggedPass = {COMPOUND_STRING("デコボコさんどう"), -1};
static const struct Landmark Landmark_BerryMastersHouse = {COMPOUND_STRING("きのみ めいじんのいえ"), FLAG_LANDMARK_BERRY_MASTERS_HOUSE};
static const struct Landmark Landmark_IslandCave = {COMPOUND_STRING("こじまのよこあな"), FLAG_LANDMARK_ISLAND_CAVE};
static const struct Landmark Landmark_DesertRuins = {COMPOUND_STRING("さばくいせき"), FLAG_LANDMARK_DESERT_RUINS};
static const struct Landmark Landmark_ScorchedSlab = {COMPOUND_STRING("ひでりのいわと"), FLAG_LANDMARK_SCORCHED_SLAB};
static const struct Landmark Landmark_AncientTomb = {COMPOUND_STRING("こだいづか"), FLAG_LANDMARK_ANCIENT_TOMB};
static const struct Landmark Landmark_SealedChamber = {COMPOUND_STRING("おふれのせきしつ"), FLAG_LANDMARK_SEALED_CHAMBER};
static const struct Landmark Landmark_FossilManiacsHouse = {COMPOUND_STRING("かせきマニアのいえ"), FLAG_LANDMARK_FOSSIL_MANIACS_HOUSE};
static const struct Landmark Landmark_HuntersHouse = {COMPOUND_STRING("ハンターのこや"), FLAG_LANDMARK_HUNTERS_HOUSE};
static const struct Landmark Landmark_SkyPillar = {COMPOUND_STRING("そらのはしら"), FLAG_LANDMARK_SKY_PILLAR};
static const struct Landmark Landmark_MirageTower = {COMPOUND_STRING("げんえいのとう"), FLAG_LANDMARK_MIRAGE_TOWER};
static const struct Landmark Landmark_AlteringCave = {COMPOUND_STRING("へんげのどうくつ"), FLAG_LANDMARK_ALTERING_CAVE};
static const struct Landmark Landmark_DesertUnderpass = {COMPOUND_STRING("さばくのちかどう"), FLAG_LANDMARK_DESERT_UNDERPASS};
static const struct Landmark Landmark_TrainerHill = {COMPOUND_STRING("トレーナーヒル"), FLAG_LANDMARK_TRAINER_HILL};
