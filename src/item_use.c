...
static const u8 sText_CantDismountBike[] = _("ここでは おりられない!{PAUSE_UNTIL_PRESS}");
static const u8 sText_ItemFinderNearby[] = _("おっ!\nマシンが はんのう しているぞ!\pちかくに どうぐが うまってる!!{PAUSE_UNTIL_PRESS}");
static const u8 sText_ItemFinderOnTop[] = _("マシンが あしもとで\nすごく はんのう しているぞ!{PAUSE_UNTIL_PRESS}");
static const u8 sText_ItemFinderNothing[] = _("…… …… ふう!\n…… なんにも はんのう しない{PAUSE_UNTIL_PRESS}");
static const u8 sText_CoinCase[] = _("あなたの コイン\n{STR_VAR_1}まい{PAUSE_UNTIL_PRESS}");
static const u8 sText_PowderQty[] = _("こなの りょう {STR_VAR_1}{PAUSE_UNTIL_PRESS}");
static const u8 sText_BootedUpTM[] = _("わざマシンを きどうした!");
static const u8 sText_BootedUpHM[] = _("ひでんマシンを きどうした!");
static const u8 sText_TMHMContainedVar1[] = _("なかには {STR_VAR_1}が\nきろくされていた!\p{STR_VAR_1}を\nポケモンに おぼえさせますか?");
...
static const u8 sText_PlayedPokeFluteCatchy[] = _("ポケモンのふえを つかった!\pうーん!\nすばらしい ねいろだ!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayedPokeFlute[] = _("ポケモンのふえを つかった!");
static const u8 sText_PokeFluteAwakenedMon[] = _("ふえのねを きいた\nポケモンは めを さました{PAUSE_UNTIL_PRESS}");
...
static const u8 sText_CantThrowPokeBall_TwoMons[] = _("だめだ! 1ぴき じゃないと\nねらいが さだまらない……!\p");
static const u8 sText_CantThrowPokeBall_SemiInvulnerable[] = _("だめだ! ポケモンが みえなくて\nねらいが さだまらない……!\p");
static const u8 sText_CantThrowPokeBall_Disabled[] = _("ボールを なげることが できない!\p");
