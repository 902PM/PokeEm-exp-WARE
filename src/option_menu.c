...
static const u8 gText_Option[]             = _("せっていを かえる");
...
static const u8 gText_BattleSceneOn[]      = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}みる");
static const u8 gText_BattleSceneOff[]     = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}みない");
...
static const u8 gText_ButtonTypeLEqualsA[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}L{EMOJI_EQUALS}A");
...
static const u8 *const sOptionMenuItemsNames[MENUITEM_COUNT] =
{
    ...
    [MENUITEM_BATTLESCENE] = COMPOUND_STRING("せんとうエフェクト"),
    [MENUITEM_BATTLESTYLE] = COMPOUND_STRING("しあいの ルール"),
    [MENUITEM_SOUND]       = COMPOUND_STRING("サウンド"),
    [MENUITEM_BUTTONMODE]  = COMPOUND_STRING("ボタンの モード"),
    [MENUITEM_FRAMETYPE]   = COMPOUND_STRING("ウインドウ"),
    [MENUITEM_CANCEL]      = COMPOUND_STRING("おわる"),
};
