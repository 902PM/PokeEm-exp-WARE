...
static const u8 sText_OhABite[] = _("ひいてる ひいてる!!");
static const u8 sText_PokemonOnHook[] = _("ポケモンを つりあげた!{PAUSE_UNTIL_PRESS}");
static const u8 sText_NotEvenANibble[] = _("つれないなあ・・・{PAUSE_UNTIL_PRESS}");
static const u8 sText_ItGotAway[] = _("にげられて しまった・・・{PAUSE_UNTIL_PRESS}");
