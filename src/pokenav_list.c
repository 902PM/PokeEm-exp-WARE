...
static const u8 gText_PokenavMatchCall_Strategy[] = _("さくせん");
static const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("もってる ポケモン");
static const u8 gText_PokenavMatchCall_SelfIntroduction[] = _("じこしょうかい");
