...
{
    static const u8 gText_Morning[] = _("{DPAD_UPDOWN} あさ");
    static const u8 gText_Day[] = _("{DPAD_UPDOWN} ひる");
    static const u8 gText_Evening[] = _("{DPAD_UPDOWN} ゆうがた");
    static const u8 gText_Night[] = _("{DPAD_UPDOWN} よる");
...
static void ShowAreaUnknownLabel(void)
{
    static const u8 gText_AreaUnknown[] = _("せいそくちふめい");
