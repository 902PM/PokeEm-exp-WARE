...
static const u8 sText_doneText[] = _("{STR_VAR_1}の とくせいが\n{STR_VAR_2}に へんかした!{PAUSE_UNTIL_PRESS}");
...
static const u8 sText_CannotSendMonToBoxPartner[] = _("じぶんの ポケモンでは ないので\nボックスへ おくることが できません!{PAUSE_UNTIL_PRESS}");
...
{
    static const u8 sText_askText[] = _("{STR_VAR_1}の のうりょくを\nへんかさせますか?");
