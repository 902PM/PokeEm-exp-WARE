...
static const u8 sText_PlayerDefeatedLinkTrainerTrainer1[] = _("{JPN}{B_TRAINER1_CLASS}の {B_TRAINER1_NAME}\nとの しょうぶに かった!\p");
...
static const u8 sText_Trainer1SentOutPkmn2[] = _("{JPN}{B_TRAINER1_CLASS}の {B_TRAINER1_NAME}は\n{B_BUFF1}を くりだした!");
...
static const u8 sText_LinkTrainerSentOutTwoPkmn[] = _("{JPN}{B_LINK_OPPONENT1_NAME}\n{B_OPPONENT_MON1_NAME}と {B_OPPONENT_MON2_NAME}を くりだした!");
static const u8 sText_TwoLinkTrainersIntroSendOutPkmn[] = _("{JPN}{B_LINK_OPPONENT1_NAME}は {B_LINK_OPPONENT_MON1_NAME}を くりだした!\n{B_LINK_OPPONENT2_NAME}は {B_LINK_OPPONENT_MON2_NAME}を くりだした!");
...
static const u8 sText_LinkPartnerSentOutPkmn2GoPkmn[] = _("{JPN}{B_LINK_PARTNER_NAME}は {B_LINK_PLAYER_MON2_NAME}を くりだした!\nゆけっ! {B_LINK_PLAYER_MON1_NAME}!");
...
static const u8 sText_Trainer2WithdrewPkmn[] = _("{JPN}{B_TRAINER2_CLASS}の {B_TRAINER2_NAME}は\n{B_BUFF1}を ひっこめた!");
static const u8 sText_LinkTrainer1WithdrewPkmn[] = _("{JPN}{B_LINK_OPPONENT1_NAME}は\n{B_BUFF1}を ひっこめた!");
static const u8 sText_LinkTrainer2WithdrewPkmn[] = _("{JPN}{B_LINK_OPPONENT2_NAME}は\n{B_BUFF1}を ひっこめた!");
...
static const u8 sText_ExclamationMark[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_BUFF3}を つかった!");
static const u8 sText_ExclamationMark2[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_BUFF3}した!");
static const u8 sText_ExclamationMark3[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_BUFF3}を した!");
static const u8 sText_ExclamationMark4[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}の {B_BUFF3} こうげき!");
static const u8 sText_ExclamationMark5[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}の {B_BUFF3}!");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNGREWTOLV]                         = COMPOUND_STRING("{JPN}{B_BUFF1}は\nレベル{B_BUFF2} に あがった!{WAIT_SE}\p"),
    [STRINGID_PKMNLEARNEDMOVE]                      = COMPOUND_STRING("{JPN}{B_BUFF1}は\n{B_BUFF2}を おぼえた!{WAIT_SE}\p"),
    ...
    [STRINGID_STOPLEARNINGMOVE]                     = COMPOUND_STRING("{JPN}{PAUSE 32}それでは…… {B_BUFF2}を\nおぼえるのを あきらめますか?"),
    [STRINGID_DIDNOTLEARNMOVE]                      = COMPOUND_STRING("{JPN}{B_BUFF1}は {B_BUFF2}を\nおぼえずに おわった!\p"),
    [STRINGID_PKMNLEARNEDMOVE2]                     = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\n{B_BUFF1}を おぼえた!"),
    [STRINGID_PKMNPROTECTEDITSELF]                  = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nこうげきから みを まもった!"),
    ...
    [STRINGID_PKMNRAISEDSPDEF]                      = COMPOUND_STRING("{JPN}{B_ATK_TEAM2}は ひかりのかべで\nとくこうに つよくなった!"),
    [STRINGID_PKMNRAISEDDEF]                        = COMPOUND_STRING("{JPN}{B_ATK_TEAM2}は リフレクターで\nだげきこうげきに つよくなった!"),
    [STRINGID_PKMNAURORAVEIL]                       = COMPOUND_STRING("{JPN}{B_ATK_TEAM2}は オーロラベールで\nぶつりと とくしゅに つよくなった!"),
    [STRINGID_PKMNCOVEREDBYVEIL]                    = COMPOUND_STRING("{JPN}{B_ATK_TEAM2}は\nしんぴのベールに つつまれた!"),
    [STRINGID_PKMNUSEDSAFEGUARD]                    = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nしんぴのベールに つつまれた!"),
    [STRINGID_PKMNSAFEGUARDEXPIRED]                 = COMPOUND_STRING("{JPN}{B_ATK_TEAM2}を つつんでいた\nしんぴのベールが なくなった!"),
    ...
    [STRINGID_BATTLERAVOIDEDATTACK]                 = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nこうげきを かわした!"),
    ...
    [STRINGID_SPIKESSCATTERED]                      = COMPOUND_STRING("{JPN}{B_DEF_TEAM2}の あしもとに\nまきびしが ちらばった!"),
    ...
    [STRINGID_PKMNCOPIEDSTATCHANGES]                = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}の\nほじょこうかを コピーした!"),
    ...
    [STRINGID_ENEMYABOUTTOSWITCHPKMN]               = COMPOUND_STRING("{JPN}{B_TRAINER1_CLASS}の {B_TRAINER1_NAME}は\n{B_BUFF2}を くりだそうと している\p{B_PLAYER_NAME}も ポケモンを\nいれかえますか?"),
    ...
    [STRINGID_PKMNHUNGONWITHX]                      = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は\n{B_LAST_ITEM}で もちこたえた!"),
    ...
    [STRINGID_PKMNSXMADEYINEFFECTIVE]               = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}で\nどうぐを はずせない!"),
    ...
    [STRINGID_ITEMSCANTBEUSEDNOW]                   = COMPOUND_STRING("{JPN}ここでは どうぐを つかうことは\nできません!{PAUSE 64}"), // Not present in Gen 5+
    ...
    [STRINGID_TRAINER1USEDITEM]                     = COMPOUND_STRING("{JPN}{B_ATK_TRAINER_CLASS}の {B_ATK_TRAINER_NAME}は\n{B_LAST_ITEM}を つかった!"),
    ...
    [STRINGID_PKMNWENTBACK]                         = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\n{B_ATK_TRAINER_NAME}のもとへ もどっていく!"),
    [STRINGID_PKMNCANTUSEITEMSANYMORE]              = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}には\nどうぐが つかえなくなった!"),
    [STRINGID_PKMNFLUNG]                            = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は\n{B_LAST_ITEM}を なげつけた!"),
    [STRINGID_PKMNPREVENTEDFROMHEALING]             = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は\nかいふくどうさを ふうじられた!"),
    [STRINGID_PKMNSWITCHEDATKANDDEF]                = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nこうげきと ぼうぎょを いれかえた!"),
    [STRINGID_PKMNSABILITYSUPPRESSED]               = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}の\nとくせいが きかなくなった!"),
    [STRINGID_SHIELDEDFROMCRITICALHITS]             = COMPOUND_STRING("{JPN}おまじないの ちからで \n{B_ATK_TEAM2}の きゅうしょが かくれた!"),
    [STRINGID_PKMNACQUIREDABILITY]                  = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は\n{B_DEF_ABILITY}になった!"),
    [STRINGID_POISONSPIKESSCATTERED]                = COMPOUND_STRING("{JPN}{B_DEF_TEAM2}の あしもとに\nどくびしが ちらばった!"),
    [STRINGID_PKMNSWITCHEDSTATCHANGES]              = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は あいてとじぶんの\nのうりょくへんかを いれかえた!"),
    [STRINGID_PKMNSURROUNDEDWITHVEILOFWATER]        = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nみずのリングを まとった!"),
    [STRINGID_PKMNLEVITATEDONELECTROMAGNETISM]      = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nでんじりょくで うかびあがった!"),
    [STRINGID_PKMNTWISTEDDIMENSIONS]                = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nじくうを ゆがめた!"),
    [STRINGID_POINTEDSTONESFLOAT]                   = COMPOUND_STRING("{JPN}{B_DEF_TEAM2}の まわりに\nとがった いわが ただよいはじめた!"),
    [STRINGID_TRAPPEDBYSWIRLINGMAGMA]               = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は\nマグマの うずに とじこめられた!"),
    [STRINGID_VANISHEDINSTANTLY]                    = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}のすがたが\nいっしゅんにして きえた!"),
    [STRINGID_PROTECTEDTEAM]                        = COMPOUND_STRING("{JPN}{B_CURRENT_MOVE}で {B_ATK_TEAM2}は\nまもられた!"),
    [STRINGID_SHAREDITSGUARD]                       = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nおたがいのガードを シェアした!"),
    [STRINGID_SHAREDITSPOWER]                       = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nおたがいのパワーを シェアした!"),
    [STRINGID_SWAPSDEFANDSPDEFOFALLPOKEMON]         = COMPOUND_STRING("{JPN}ぼうぎょと とくぼうが いれかわる\nくうかんを つくりだした!"),
    [STRINGID_BECAMENIMBLE]                         = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は\nみがるになった!"),
    [STRINGID_HURLEDINTOTHEAIR]                     = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は\nフリーフォールから かいほうされた!"),
    [STRINGID_HELDITEMSLOSEEFFECTS]                 = COMPOUND_STRING("{JPN}もたせた どうぐの こうかが\nなくなる くうかんを つくりだした!"),
    [STRINGID_FELLSTRAIGHTDOWN]                     = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は\nうちおとされて じめんに おちた!"),
    [STRINGID_TARGETCHANGEDTYPE]                    = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は\n{B_BUFF1}タイプに なった!"),
    [STRINGID_KINDOFFER]                            = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は\nおことばに あまえることにした!"),
    [STRINGID_RESETSTARGETSSTATLEVELS]              = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}の\nステータスが もとに もどった!"),
    [STRINGID_ALLYSWITCHPOSITION]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}と {B_SCR_NAME_WITH_PREFIX2}は\nばしょを いれかえた!"),
    [STRINGID_REFLECTTARGETSTYPE]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_DEF_NAME_WITH_PREFIX2}と\nおなじタイプに なった!"),
    [STRINGID_EMBARGOENDS]                          = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}に\nどうぐが つかえるようになった!"),
    [STRINGID_ELECTROMAGNETISM]                     = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nでんじりょくが なくなった!"),
    [STRINGID_BUFFERENDS]                           = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}の {B_BUFF1}の\nこうかが きれた!"),
    [STRINGID_TELEKINESISENDS]                      = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nテレキネシスから かいほうされた!"),
    [STRINGID_TAILWINDENDS]                         = COMPOUND_STRING("{JPN}{B_ATK_TEAM1}\nおいかぜが やんだ!"),
    [STRINGID_LUCKYCHANTENDS]                       = COMPOUND_STRING("{JPN}{B_ATK_TEAM1}\nおまじないが とけた!"),
    [STRINGID_TRICKROOMENDS]                        = COMPOUND_STRING("{JPN}ゆがんだ じくうが もとに もどった!"),
    [STRINGID_WONDERROOMENDS]                       = COMPOUND_STRING("{JPN}ワンダールームが かいじょされ\nぼうぎょと とくぼうが もとにもどった!"),
    [STRINGID_MAGICROOMENDS]                        = COMPOUND_STRING("{JPN}マジックルームが かいじょされ\nどうぐの こうかが もとにもどった!"),
    [STRINGID_MUDSPORTENDS]                         = COMPOUND_STRING("{JPN}どろあそびの こうかが\nなくなった!"),
    [STRINGID_WATERSPORTENDS]                       = COMPOUND_STRING("{JPN}みずあそびの こうかが\nなくなった!"),
    [STRINGID_GRAVITYENDS]                          = COMPOUND_STRING("{JPN}じゅうりょくが もとにもどった!"),
    [STRINGID_AQUARINGHEAL]                         = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX2}は みずのリングで\nたいりょくを かいふく!"),
    [STRINGID_ELECTRICTERRAINENDS]                  = COMPOUND_STRING("{JPN}エレキフィールドが きえさった!"),
    [STRINGID_MISTYTERRAINENDS]                     = COMPOUND_STRING("{JPN}ミストフィールドが きえさった!"),
    [STRINGID_PSYCHICTERRAINENDS]                   = COMPOUND_STRING("{JPN}サイコフィールドが きえさった!"),
    [STRINGID_GRASSYTERRAINENDS]                    = COMPOUND_STRING("{JPN}グラスフィールドが きえさった!"),
    ...
    [STRINGID_STATWASMAXEDOUT]                      = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は {B_BUFF1}が\nさいだいまで あがった!"),
    [STRINGID_ATTACKERABILITYSTATRAISE]             = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}の {B_ATK_ABILITY}で\n{B_BUFF1}が{B_BUFF2} あがった!"), // Not in Gen 5+
    [STRINGID_POISONHEALHPUP]                       = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX2}は {B_LAST_ITEM}で\nすこし かいふく"), // Not in Gen 5+
    [STRINGID_BADDREAMSDMG]                         = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は\nあくむに うなされている!"),
    [STRINGID_MOLDBREAKERENTERS]                    = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は かたやぶりだ!"),
    [STRINGID_TERAVOLTENTERS]                       = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nはじける オーラを はなっている!"),
    [STRINGID_TURBOBLAZEENTERS]                     = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nもえさかる オーラを はなっている!"),
    ...
    [STRINGID_UNNERVEENTERS]                        = COMPOUND_STRING("{JPN}きんちょうして きのみが\nたべられなくなった!"),
    [STRINGID_HARVESTBERRY]                         = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\n{B_LAST_ITEM}を しゅうかくした!"),
    ...
    [STRINGID_STEALTHROCKDMG]                       = COMPOUND_STRING("{JPN}いわが {B_SCR_NAME_WITH_PREFIX2}に\nとがった いわが くいこんだ!"),
    [STRINGID_TOXICSPIKESABSORBED]                  = COMPOUND_STRING("{JPN}{B_EFF_TEAM2} あしもとの\nどくびしが きえさった!"),
    [STRINGID_TOXICSPIKESPOISONED]                  = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nどくを あびた!"),
    [STRINGID_TOXICSPIKESBADLYPOISONED]             = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nもうどくを あびた!"),
    [STRINGID_STICKYWEBSWITCHIN]                    = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は\nねばねばネットに ひっかかった!"),
    [STRINGID_HEALINGWISHCAMETRUE]                  = COMPOUND_STRING("{JPN}いやしのねがいが {B_SCR_NAME_WITH_PREFIX2}に とどいた!"),
    [STRINGID_HEALINGWISHHEALED]                    = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}の\nたいりょくが かいふくした!"),
    [STRINGID_LUNARDANCECAMETRUE]                   = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は しんぴてきな\nつきの ひかりに つつまれた!"),
    [STRINGID_CURSEDBODYDISABLED]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}の\n{B_BUFF1}を ふうじこめた!"),
    [STRINGID_ATTACKERACQUIREDABILITY]              = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nとくせいが ミイラになっちゃった!"), // Not in Gen 5+
    [STRINGID_TARGETABILITYSTATLOWER]               = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}の\n{B_DEF_ABILITY}で\n{B_BUFF1}が{B_BUFF2} さがった!"), // Not in Gen 5+
    [STRINGID_TARGETSTATWONTGOHIGHER]               = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}の\n{B_BUFF1}は もう あがらない!"),
    [STRINGID_PKMNMOVEBOUNCEDABILITY]               = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}の\n{B_CURRENT_MOVE}を はねかえした!"),
    ...
    [STRINGID_GRAVITYPREVENTSUSAGE]                 = COMPOUND_STRING("{JPN}じゅうりょくが つよくて\n{B_CURRENT_MOVE}が だせない!\p"),
    ...
    [STRINGID_STICKYWEBUSED]                        = COMPOUND_STRING("{JPN}{B_DEF_TEAM2}の あしもとに\nねばねばネットが ひろがった!"),
    [STRINGID_QUASHSUCCESS]                         = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}の じゅんばんを\nさきおくりした!"),
    [STRINGID_PKMNBLEWAWAYTOXICSPIKES]              = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} あしもとの どくびしが\nきえさった!"),
    [STRINGID_PKMNBLEWAWAYSTICKYWEB]                = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} あしもとの ねばねばネットが\nきえさった!"),
    [STRINGID_PKMNBLEWAWAYSTEALTHROCK]              = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} あしもとの ステルスロックが\nきえさった!"),
    [STRINGID_IONDELUGEON]                          = COMPOUND_STRING("{JPN}でんしのシャワーが ふりそそいだ!"),
    [STRINGID_TOPSYTURVYSWITCHEDSTATS]              = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX2}は\nのうりょくへんかが ひっくりかえった!"),
    [STRINGID_TERRAINBECOMESMISTY]                  = COMPOUND_STRING("{JPN}あしもとに きりが たちこめた!"),
    [STRINGID_TERRAINBECOMESGRASSY]                 = COMPOUND_STRING("{JPN}あしもとに くさが おいしげった!"),
    [STRINGID_TERRAINBECOMESELECTRIC]               = COMPOUND_STRING("{JPN}あしもとに でんきが かけめぐる!"),
    [STRINGID_TERRAINBECOMESPSYCHIC]                = COMPOUND_STRING("{JPN}あしもとが ふしぎな\nかんじに なった!"),
    ...
    [STRINGID_MEGAEVOEVOLVED]                       = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nメガ{B_BUFF1}に メガシンカした!"),
    [STRINGID_DRASTICALLY]                          = gText_drastically,
    [STRINGID_SEVERELY]                             = gText_severely,
    [STRINGID_INFESTATION]                          = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は\n{B_SCR_NAME_WITH_PREFIX2}に まとわりつかれた!"),
    [STRINGID_NOEFFECTONTARGET]                     = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX2}には\nこうかが ないようだ…"),
    [STRINGID_BURSTINGFLAMESHIT]                    = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX2}にも\nひばなが ふりかかった!"),
    [STRINGID_BESTOWITEMGIVING]                     = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は {B_ATK_NAME_WITH_PREFIX2}から\n{B_LAST_ITEM}を うけとった!"),
    [STRINGID_THIRDTYPEADDED]                       = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX2}に\n{B_BUFF1}タイプが ついかされた!"),
    [STRINGID_FELLFORFEINT]                         = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は\nフェイントに ひっかかった!"),
    [STRINGID_POKEMONCANNOTUSEMOVE]                 = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_CURRENT_MOVE}を\nつかえない!"),
    [STRINGID_COVEREDINPOWDER]                      = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}に\nふんじんを あびせた!"),
    [STRINGID_POWDEREXPLODES]                       = COMPOUND_STRING("{JPN}ほのおに はんのうして\nふんじんが ばくはつした!"),
    [STRINGID_BELCHCANTSELECT]                      = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は きのみを たべていないので\nわざが だせない!\p"),
    [STRINGID_SPECTRALTHIEFSTEAL]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は あがった のうりょくを\nうばいとった!"),
    [STRINGID_GRAVITYGROUNDING]                     = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は じゅうりょくの えいきょうで\nくうちゅうに いられなくなった!"),
    ...
    [STRINGID_SAFETYGOGGLESPROTECTED]               = COMPOUND_STRING("{JPN}{B_LAST_ITEM}の こうかで\n{B_SCR_NAME_WITH_PREFIX}には きかない!"),
    ...
    [STRINGID_PKMNCANTUSEMOVETHROATCHOP]            = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nじごくづきの こうかで わざが だせない!\p"),
    [STRINGID_LASERFOCUS]                           = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nせいしんを とぎすました!"),
    [STRINGID_GEMACTIVATES]                         = COMPOUND_STRING("{JPN}{B_LAST_ITEM}は\n{B_ATK_NAME_WITH_PREFIX2}の いりょくを つよめた!"),
    [STRINGID_BERRYDMGREDUCES]                      = COMPOUND_STRING("{JPN}{B_LAST_ITEM}は\n{B_SCR_NAME_WITH_PREFIX2}の いりょくを よわめた!"),
    [STRINGID_AIRBALLOONFLOAT]                      = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nふうせんで ういている!"),
    [STRINGID_AIRBALLOONPOP]                        = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}の\nふうせんが われた!"),
    [STRINGID_INCINERATEBURN]                       = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}の\n{B_LAST_ITEM}は やけてなくなった!"),
    [STRINGID_BUGBITE]                              = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nあいての {B_LAST_ITEM}を うばって たべた!"),
    ...
    [STRINGID_ATTACKERLOSTFIRETYPE]                 = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}の\nほのおは もえつきた!"),
    ...
    [STRINGID_RECEIVERABILITYTAKEOVER]              = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\n{B_SCR_ABILITY}を ひきついだ!"),
    [STRINGID_PKNMABSORBINGPOWER]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nパワーを ためこんでいる!"),
    [STRINGID_NOONEWILLBEABLETORUNAWAY]             = COMPOUND_STRING("{JPN}つぎのターンは にげられない!"),
    [STRINGID_DESTINYKNOTACTIVATES]                 = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は {B_LAST_ITEM}で\nメロメロに なった!"),
    [STRINGID_CLOAKEDINAFREEZINGLIGHT]              = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nいてつく ひかりに つつまれた!"),
    [STRINGID_CLEARAMULETWONTLOWERSTATS]            = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX2}の {B_LAST_ITEM}で\nのうりょくは さがらない!"),
    [STRINGID_FERVENTWISHREACHED]                   = COMPOUND_STRING("{JPN}{B_ATK_TRAINER_NAME}の つよい いのりが\n{B_ATK_NAME_WITH_PREFIX2}に とどく!"),
    [STRINGID_AIRLOCKACTIVATES]                     = COMPOUND_STRING("{JPN}てんこうの えいきょうが なくなった!"),
    [STRINGID_PRESSUREENTERS]                       = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nプレッシャーを はなっている!"),
    [STRINGID_DARKAURAENTERS]                       = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nダークオーラを はなっている!"),
    [STRINGID_FAIRYAURAENTERS]                      = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nフェアリーオーラを はなっている!"),
    [STRINGID_AURABREAKENTERS]                      = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nすべての オーラを せいあつする!"),
    ...
    [STRINGID_PKMNSWILLPERISHIN3TURNS]              = COMPOUND_STRING("{JPN}おたがいは 3ターンごに ほろびてしまう!"),
    ...
    [STRINGID_CANACTFASTERTHANKSTO]                 = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_BUFF1}で\nこうどうが はやくなった!"),
    [STRINGID_MICLEBERRYACTIVATES]                  = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は {B_LAST_ITEM}で\nつぎに くりだす わざが あたりやすくなった!"),
    [STRINGID_PKMNSHOOKOFFTHETAUNT]                 = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nちょうはつの こうかが とけた!"),
    [STRINGID_PKMNGOTOVERITSINFATUATION]            = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nメロメロが とけた!"),
    ...
    [STRINGID_TORMENTEDNOMORE]                      = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}の\nいちゃもんの こうかが きれた!"),
    [STRINGID_HEALBLOCKEDNOMORE]                    = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nかいふくふうじの こうかが きれた!"),
    [STRINGID_ATTACKERBECAMEFULLYCHARGED]           = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}に\nきずなの ちからが みなぎった!\p"),
    [STRINGID_ATTACKERBECAMEASHSPECIES]             = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nサトシゲッコウガに へんげした!\p"),
    [STRINGID_EXTREMELYHARSHSUNLIGHT]               = COMPOUND_STRING("{JPN}ひざしが とても つよくなった!"),
    [STRINGID_EXTREMESUNLIGHTFADED]                 = COMPOUND_STRING("{JPN}ひざしが もとに もどった!"),
    [STRINGID_MOVEEVAPORATEDINTHEHARSHSUNLIGHT]     = COMPOUND_STRING("{JPN}つよいひざしの えいきょうで\nみずタイプの こうげきが じょうはつした!"),
    [STRINGID_EXTREMELYHARSHSUNLIGHTWASNOTLESSENED] = COMPOUND_STRING("{JPN}つよい ひざしの\nいきおいは とまらない!"),
    [STRINGID_HEAVYRAIN]                            = COMPOUND_STRING("{JPN}つよい あめが ふりはじめた!"),
    [STRINGID_HEAVYRAINLIFTED]                      = COMPOUND_STRING("{JPN}つよい あめが あがった!"),
    [STRINGID_MOVEFIZZLEDOUTINTHEHEAVYRAIN]         = COMPOUND_STRING("{JPN}つよい あめの えいきょうで\nほのおタイプの こうげきが かきけされた!"),
    [STRINGID_NORELIEFROMHEAVYRAIN]                 = COMPOUND_STRING("{JPN}つよい あめの\nいきおいは とまらない!"),
    ...
    [STRINGID_MYSTERIOUSAIRCURRENTBLOWSON]          = COMPOUND_STRING("{JPN}なぞの らんきりゅうの\nいきおいは とまらない!"),
    ...
    [STRINGID_BROKETHROUGHPROTECTION]               = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX2}の\nまもりを うちやぶった!"),
    [STRINGID_ABILITYALLOWSONLYMOVE]                = COMPOUND_STRING("{JPN}{B_ATK_ABILITY}の ため\n{B_CURRENT_MOVE}しか つかえない!\p"),
    [STRINGID_SWAPPEDABILITIES]                     = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は\nおたがいの とくせいを いれかえた!"),
    [STRINGID_PKMNHEALEDPOISON]                     = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}の\nどくは きれい さっぱり なくなった!"),
    [STRINGID_BATTLERTYPECHANGEDTO]                 = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\n{B_BUFF1}タイプに なった!"),
    ...
    [STRINGID_ABOUTTOUSEPOLTERGEIST]                = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}に\n{B_LAST_ITEM}が おそいかかる!"),
    [STRINGID_CANTESCAPEBECAUSEOFCURRENTMOVE]       = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は\nたこがためで にげられなくなった!"),
    ...
    [STRINGID_TARGETTOOHEAVY]                       = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は\nおもすぎて もちあげられない!"),
    [STRINGID_PKMNTOOKTARGETHIGH]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_DEF_NAME_WITH_PREFIX2}を\nじょうくうに つれさった!"),
    [STRINGID_PKMNINSNAPTRAP]                       = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は\nトラバサミに とらわれた!"),
    [STRINGID_METEORBEAMCHARGING]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}に\nうちゅうの ちからが あふれだす!"),
    [STRINGID_HEATUPBEAK]                           = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nクチバシを かねつ しはじめた!"),
    [STRINGID_COURTCHANGE]                          = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は おたがいの\nばの こうかを いれかえた!"),
    [STRINGID_ZPOWERSURROUNDS]                      = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は Zパワーを\nからだに まとった!"),
    [STRINGID_ZMOVEUNLEASHED]                       = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}が ときはなつ\nぜんりょくの Zワザ!"),
    [STRINGID_ZMOVERESETSSTATS]                     = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は Zパワーで\nさがった のうりょくを もどした!"),
    [STRINGID_ZMOVEALLSTATSUP]                      = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は Zパワーで\nのうりょくが あがった!"),
    [STRINGID_ZMOVEZBOOSTCRIT]                      = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は Zパワーで\nきゅうしょに あたりやすくなった!"),
    [STRINGID_ZMOVERESTOREHP]                       = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は Zパワーで\nたいりょくが かいふくした!"),
    [STRINGID_ZMOVESTATUP]                          = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は Zパワーで\nのうりょくが あがった!"),
    [STRINGID_ZMOVEHPTRAP]                          = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は Zパワーで\nかいふくした!"),
    ...
    [STRINGID_SPIKESDISAPPEAREDFROMTEAM]            = COMPOUND_STRING("{JPN} {B_ATK_TEAM2}の あしもとの\nまきびしが きえさった!"),
    [STRINGID_TOXICSPIKESDISAPPEAREDFROMTEAM]       = COMPOUND_STRING("{JPN} {B_ATK_TEAM2}の あしもとの\nどくびしが きえさった!"),
    [STRINGID_STICKYWEBDISAPPEAREDFROMTEAM]         = COMPOUND_STRING("{JPN} {B_ATK_TEAM2}の あしもとの\nねばねばネットが きえさった!"),
    [STRINGID_STEALTHROCKDISAPPEAREDFROMTEAM]       = COMPOUND_STRING("{JPN}{B_ATK_TEAM2}の まわりの\nステルスロックが きえさった!"),
    [STRINGID_COULDNTFULLYPROTECT]                  = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は こうげきを\nまもりきれずに ダメージを うけた!"),
    [STRINGID_STOCKPILEDEFFECTWOREOFF]              = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}が\nたくわえていた こうかが きれた!"),
    [STRINGID_PKMNREVIVEDREADYTOFIGHT]              = COMPOUND_STRING("{JPN}{B_BUFF1}は ふっかつして\nまた たたかえるように なった!"),
    [STRINGID_ITEMRESTOREDSPECIESHEALTH]            = COMPOUND_STRING("{JPN}{B_BUFF1}は {B_LAST_ITEM}で\nたいりょくを かいふくした!"),
    [STRINGID_ITEMCUREDSPECIESSTATUS]               = COMPOUND_STRING("{JPN}{B_BUFF1}の じょうたいが なおった!"), // Not in Gen 5+
    [STRINGID_ITEMRESTOREDSPECIESPP]                = COMPOUND_STRING("{JPN}{B_BUFF1}は {B_LAST_ITEM}で\n{B_BUFF2}の わざポイントを かいふくした!"),
    [STRINGID_THUNDERCAGETRAPPED]                   = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX2}\n{B_SCR_NAME_WITH_PREFIX}に とじこめられた!"),
    ...
    [STRINGID_MIRRORHERBCOPIED]                     = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は ものまねハーブを つかって\nあいての のうりょくへんかを まねした!"),
    ...
    [STRINGID_ULTRABURSTREACTING]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX2}から\nまばゆい ひかりが あふれだす!"),
    [STRINGID_ULTRABURSTCOMPLETED]                  = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}が ウルトラバーストで\nあらたな すがたを あらわした!"),
    [STRINGID_TEAMGAINEDEXP]                        = COMPOUND_STRING("{JPN}がくしゅうそうちで それぞれ\nけいけんちを もらった!\p"),
    ...
    [STRINGID_SHARPSTEELFLOATS]                     = COMPOUND_STRING("{JPN}{B_DEF_TEAM2}に\nとがった いわが くいこんだ!"),
    [STRINGID_SHARPSTEELDMG]                        = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX2}に\nとがった はがねが くいこんだ!"),
    [STRINGID_PKMNBLEWAWAYSHARPSTEEL]               = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nするどい はがねを ふきとばした!"),
    [STRINGID_SHARPSTEELDISAPPEAREDFROMTEAM]        = COMPOUND_STRING("{JPN}{B_ATK_TEAM2}の まわりの\nはがねが きえさった!"),
    [STRINGID_TEAMTRAPPEDWITHVINES]                 = COMPOUND_STRING("{JPN}{B_EFF_TEAM1} ポケモンが\nツルに とらわれた!"),
    [STRINGID_PKMNHURTBYVINES]                      = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は キョダイベンタツの\nもうだに さらされていて いたい!"),
    [STRINGID_TEAMCAUGHTINVORTEX]                   = COMPOUND_STRING("{JPN}{B_EFF_TEAM1} ポケモンが\nみずのうずに とじこめられた!"),
    [STRINGID_PKMNHURTBYVORTEX]                     = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は キョダイホウゲキの\nながれに のみこまれていて くるしい!"),
    [STRINGID_TEAMSURROUNDEDBYFIRE]                 = COMPOUND_STRING("{JPN}{B_EFF_TEAM1} ポケモンが\nほのおに つつまれた!"),
    [STRINGID_PKMNBURNINGUP]                        = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は キョダイゴクエンの\nほのおに つつまれていて あつい!"),
    [STRINGID_TEAMSURROUNDEDBYROCKS]                = COMPOUND_STRING("{JPN}{B_EFF_TEAM1}ポケモンが\nいわに かこまれた!"),
    [STRINGID_PKMNHURTBYROCKSTHROWN]                = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は キョダイフンセキの\nいわに かこまれていて いたい!"),
    [STRINGID_MOVEBLOCKEDBYDYNAMAX]                 = COMPOUND_STRING("{JPN}ダイマックスの ちからで ふせがれた!"),
    [STRINGID_ZEROTOHEROTRANSFORMATION]             = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は\nへんしんして かえってきた!"),
    [STRINGID_THETWOMOVESBECOMEONE]                 = COMPOUND_STRING("{JPN}2つのわざが 1つになった!\nコンビネーションわざ だ!{PAUSE 16}"),
    [STRINGID_ARAINBOWAPPEAREDONSIDE]               = COMPOUND_STRING("{JPN}{B_ATK_TEAM2}の そらに にじが かかった!"),
    [STRINGID_THERAINBOWDISAPPEARED]                = COMPOUND_STRING("{JPN}{B_ATK_TEAM2}の そらから にじが きえた!"),
    [STRINGID_WAITINGFORPARTNERSMOVE]               = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\n{B_ATK_PARTNER_NAME}を まっている…{PAUSE 16}"),
    [STRINGID_SEAOFFIREENVELOPEDSIDE]               = COMPOUND_STRING("{JPN}{B_DEF_TEAM2}の まわりが\nひのうみに つつまれた!"),
    [STRINGID_HURTBYTHESEAOFFIRE]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nひのうみの ダメージをうけた!"),
    [STRINGID_THESEAOFFIREDISAPPEARED]              = COMPOUND_STRING("{JPN}{B_EFF_TEAM2} まわりの\nひのうみが きえさった!"),
    [STRINGID_SWAMPENVELOPEDSIDE]                   = COMPOUND_STRING("{JPN}{B_EFF_TEAM2} まわりに\nしつげんが ひろがった!"),
    [STRINGID_THESWAMPDISAPPEARED]                  = COMPOUND_STRING("{JPN}{B_EFF_TEAM2} まわりの\nしつげんが きえさった!"),
    [STRINGID_PKMNTELLCHILLINGRECEPTIONJOKE]        = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nさむい ギャグを かました!"),
    [STRINGID_HOSPITALITYRESTORATION]               = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX2}が たてた おちゃを\n{B_EFF_NAME_WITH_PREFIX}は のみほした!"),
    [STRINGID_ELECTROSHOTCHARGING]                  = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nでんきを きゅうしゅうした!"),
    [STRINGID_ITEMWASUSEDUP]                        = COMPOUND_STRING("{JPN}{B_LAST_ITEM}は やくめを おえ\nなくなって しまった……"),
    [STRINGID_ATTACKERLOSTITSTYPE]                  = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は {B_BUFF1}タイプでは なくなった!"),
    [STRINGID_SHEDITSTAIL]                          = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nしっぽを きって みがわりにした!"),
    [STRINGID_CLOAKEDINAHARSHLIGHT]                 = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}を\nはげしい ひかりが つつむ!"),
    [STRINGID_SUPERSWEETAROMAWAFTS]                 = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX2}の ミツから\nあまいかおりが ただよっている!"),
    [STRINGID_DIMENSIONSWERETWISTED]                = COMPOUND_STRING("{JPN}じくうを ゆがめた!"),
    ...
    [STRINGID_TIDYINGUPCOMPLETE]                    = COMPOUND_STRING("{JPN}かたづけ おわり!"),
    [STRINGID_TIMETOTERASTALLIZE]                   = COMPOUND_STRING("{JPN}テラスタルエネルギーが\n{B_ATK_NAME_WITH_PREFIX}と はんのうする!"),
    [STRINGID_PKMNTERASTALLIZEDINTO]                = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\n{B_BUFF1}タイプに テラスタルした!"), // Does not exist, meant to mimic form change strings
    ...
    [STRINGID_PKMNMADESHELLGLEAM]                   = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は こうらを かがやかせた!\nタイプあいしょうを ゆがめる!"),
    ...
    [STRINGID_ELECTRICCURRENTISRUNNING]             = COMPOUND_STRING("{JPN}あしもとに でんきが かけめぐっている!"),
    [STRINGID_SEEMSWEIRD]                           = COMPOUND_STRING("{JPN}あしもとが ふしぎな かんじだ!"),
    [STRINGID_WAGGLINGAFINGER]                      = COMPOUND_STRING("{JPN}ゆびをふったら {B_CURRENT_MOVE}が でた!"),
    [STRINGID_BLOCKEDBYSLEEPCLAUSE]                 = COMPOUND_STRING("{JPN}しかし {B_DEF_NAME_WITH_PREFIX2}が\nさわいでいて ねむれなかった!"),
    [STRINGID_SUPEREFFECTIVETWOFOES]                = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX2}と {B_DEF_PARTNER_NAME}に\nこうかばつぐんだ!"),
    [STRINGID_NOTVERYEFFECTIVETWOFOES]              = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX2}と {B_DEF_PARTNER_NAME}に\nこうかは いまひとつだ"),
    ...
    [STRINGID_PKMNGIGANTAMAXED]                     = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} キョダイマックス!"),
    [STRINGID_TIMETODYNAMAX]                        = COMPOUND_STRING("{JPN}とくしゅな パワーが\nあたりの くうかんを ゆがめる……!"),
    [STRINGID_TIMETOGIGANTAMAX]                     = COMPOUND_STRING("{JPN}とくしゅな パワーが\nあたりの くうかんを ゆがめる……!"),
    ...
    [STRINGID_ABILITYSHIELDPROTECTS]                = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_LAST_ITEM}の\nこうかで とくせいが まもられている!"),
    ...
    [STRINGID_ZENMODETRIGGERED]                     = COMPOUND_STRING("{JPN}{B_SCR_ABILITY} はつどう!"),
...
static const u8 sText_InGamePartnerSentOutNGoZ[] = _("{JPN}{B_PARTNER_CLASS}の {B_PARTNER_NAME}は\n{B_PLAYER_MON1_NAME}を くりだした!\lゆけっ! {B_PLAYER_MON2_NAME}!");
static const u8 sText_InGamePartnerSentOutPkmn1[] = _("{JPN}{B_PARTNER_CLASS}の {B_PARTNER_NAME}は\n{B_PLAYER_MON1_NAME}を くりだした!");
static const u8 sText_InGamePartnerSentOutPkmn2[] = _("{JPN}{B_PARTNER_CLASS}の {B_PARTNER_NAME}は\n{B_PLAYER_MON2_NAME}を くりだした!");
static const u8 sText_InGamePartnerWithdrewPkmn1[] = _("{JPN}{B_PARTNER_CLASS}の {B_PARTNER_NAME}は\n{B_PLAYER_MON1_NAME}を ひっこめた!");
static const u8 sText_InGamePartnerWithdrewPkmn2[] = _("{JPN}{B_PARTNER_CLASS}の {B_PARTNER_NAME}は\n{B_PLAYER_MON2_NAME}を ひっこめた!");
...
static const u8 sText_PlayerLostAgainstTrainer1[] = _("{JPN}{B_TRAINER1_CLASS}の {B_TRAINER1_NAME}との\nしょうぶに まけた!");
static const u8 sText_PlayerBattledToDrawTrainer1[] = _("{JPN}{B_TRAINER1_CLASS}の {B_TRAINER1_NAME}との\n しょうぶに ひきわけた!");
...
static const u8 sText_Your2[] = _("{JPN}みかた");
static const u8 sText_Opposing2[] = _("{JPN}あいて");
