...
const u8 *const gPokeblockNames[] =
{
    ...
    [PBLOCK_CLR_RED]       = COMPOUND_STRING("あかいポロック"),
    [PBLOCK_CLR_BLUE]      = COMPOUND_STRING("あおいポロック"),
    [PBLOCK_CLR_PINK]      = COMPOUND_STRING("ももいろポロック"),
    [PBLOCK_CLR_GREEN]     = COMPOUND_STRING("みどりのポロック"),
    [PBLOCK_CLR_YELLOW]    = COMPOUND_STRING("きいろのポロック"),
    [PBLOCK_CLR_PURPLE]    = COMPOUND_STRING("むらさきポロック"),
    [PBLOCK_CLR_INDIGO]    = COMPOUND_STRING("こんいろポロック"),
    [PBLOCK_CLR_BROWN]     = COMPOUND_STRING("ちゃいろポロック"),
    [PBLOCK_CLR_LITE_BLUE] = COMPOUND_STRING("そらいろポロック"),
    [PBLOCK_CLR_OLIVE]     = COMPOUND_STRING("きみどりポロック"),
    [PBLOCK_CLR_GRAY]      = COMPOUND_STRING("はいいろポロック"),
    [PBLOCK_CLR_BLACK]     = COMPOUND_STRING("くろいポロック"),
    [PBLOCK_CLR_WHITE]     = COMPOUND_STRING("しろいポロック"),
    [PBLOCK_CLR_GOLD]      = COMPOUND_STRING("きんいろポロック")
};
