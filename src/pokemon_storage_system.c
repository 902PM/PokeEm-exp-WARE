...
static const u8 gText_JustOnePkmn[] = _("てもちポケモンが 1ひきしかいません!");
...
{
    [OPTION_WITHDRAW]   = {COMPOUND_STRING("ポケモンを つれていく"), COMPOUND_STRING("ボックスに あずけている ポケモンを \nてもちに くわえる ことが できます ")},
    [OPTION_DEPOSIT]    = {COMPOUND_STRING("ポケモンを あずける"),  COMPOUND_STRING("てもちの ポケモンを         \nボックスに あずける ことが できます   ")},
    [OPTION_MOVE_MONS]  = {COMPOUND_STRING("ポケモンを せいりする"),     COMPOUND_STRING("ボックスに あずけている ポケモンや \nてもちの ポケモンを せいり できます")},
    [OPTION_MOVE_ITEMS] = {COMPOUND_STRING("どうぐせいり"),       COMPOUND_STRING("ポケモンが もっている どうぐを\nせいり できます")},
...
static const struct StorageMessage sMessages[] =
{
    ...
    [MSG_RELEASE_POKE]         = {COMPOUND_STRING("ほんとうに にがしますか?"),      MSG_VAR_NONE},
    [MSG_WAS_RELEASED]         = {COMPOUND_STRING("{DYNAMIC 0} を そとに にがしてあげた"),  MSG_VAR_RELEASE_MON_1},
    [MSG_BYE_BYE]              = {COMPOUND_STRING("ばいばい {DYNAMIC 0} !"),      MSG_VAR_RELEASE_MON_3},
    [MSG_MARK_POKE]            = {COMPOUND_STRING("マーキングしてください"),         MSG_VAR_NONE},
    [MSG_LAST_POKE]            = {COMPOUND_STRING("たたかうポケモンが いなくなります!"),  MSG_VAR_NONE},
    [MSG_PARTY_FULL]           = {gText_YourPartysFull,                          MSG_VAR_NONE},
    [MSG_HOLDING_POKE]         = {COMPOUND_STRING("ポケモンを つかんだままですよ!"),  MSG_VAR_NONE},
    ...
    [MSG_CAME_BACK]            = {COMPOUND_STRING("{DYNAMIC 0} は かえってきた!"),     MSG_VAR_MON_NAME_1},
    ...
    [MSG_GIVE_TO_MON]          = {COMPOUND_STRING("どうぐを もたせますか?"),         MSG_VAR_NONE},
    ...
    [MSG_ITEM_IS_HELD]         = {COMPOUND_STRING("{DYNAMIC 0} を もたせた!"),   MSG_VAR_ITEM_NAME},
    [MSG_CHANGED_TO_ITEM]      = {COMPOUND_STRING("{DYNAMIC 0} と とりかえた!"),    MSG_VAR_ITEM_NAME},
...
static const u8 *const sMenuTexts[] =
{
    ...
    [MENU_SUMMARY]    = COMPOUND_STRING("ようすをみる"),
    ...
    [MENU_TAKE]       = COMPOUND_STRING("もたせる"),
    [MENU_GIVE]       = gPCText_Give,
    [MENU_GIVE_2]     = gPCText_Give,
    [MENU_SWITCH]     = COMPOUND_STRING("とりかえる"),
    [MENU_BAG]        = COMPOUND_STRING("バッグへ"),
    [MENU_INFO]       = COMPOUND_STRING("せつめい"),
    [MENU_SCENERY_1]  = COMPOUND_STRING("ふうけい1"),
    [MENU_SCENERY_2]  = COMPOUND_STRING("ふうけい2"),
    [MENU_SCENERY_3]  = COMPOUND_STRING("ふうけい3"),
    ...
    [MENU_SNOW]       = COMPOUND_STRING("ゆきやま"),
    ...
    [MENU_SELECT]     = COMPOUND_STRING("わざを おもいだす"),
};
