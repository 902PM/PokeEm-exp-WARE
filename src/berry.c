...
const struct Berry gBerries[NUM_BERRIES + 1] =
{
    ...
    [BERRY_ID_CHERI] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("とても かわいい はなが さく。"),
            .description2 = COMPOUND_STRING("まっかな みは とても からい。"),
    ...
    [BERRY_ID_CHESTO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("そとの かわの ぶぶんも なかみも すべてが"),
            .description2 = COMPOUND_STRING("かたい。 どこを たべても しぶい。"),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_PECHA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("とても あまくて おいしい。"),
            .description2 = COMPOUND_STRING("やわらかいので はこぶときは ちゅうい。"),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_RAWST] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("はっぱの ぶぶんが ながく まるまっていると"),
            .description2 = COMPOUND_STRING("みが とても にがく なるらしい。"),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_ASPEAR] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("かたい みの なかには すいぶんが とても"),
            .description2 = COMPOUND_STRING("おおく ふくまれている。 かなり すっぱい。"),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_LEPPA] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("クラボなどに くらべて すこし そだつのが"),
            .description2 = COMPOUND_STRING("おそい。 みが ちいさいほど おいしい。"),
    ...
    [BERRY_ID_ORAN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("いろいろな あじが まざった ふしぎな み。"),
            .description2 = COMPOUND_STRING("みを つけるのに はんにち かかる。"),
    ...
    [BERRY_ID_PERSIM] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("たいようが だいすき。 ひに あたると"),
            .description2 = COMPOUND_STRING("どんどん いろが あざやかに なる。"),
            .growthDuration = GROWTH_DURATION(12, 16, 24, 24, 16, 24),
            .spicy = 10,
            .dry = 10,
            .sweet = 10,
    ...
    [BERRY_ID_LUM] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("そだつのに じかんが かかるが たいせつに"),
            .description2 = COMPOUND_STRING("そだてると みが 2つ つくことも ある。"),
    ...
    [BERRY_ID_SITRUS] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("オレンとは きょうだいの ような そんざい。"),
            .description2 = COMPOUND_STRING("おおきくて あじも ととのっている。"),
    ...
    [BERRY_ID_FIGY] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("たべられた あとのような かたちの なかには"),
            .description2 = COMPOUND_STRING("からい せいぶんが つまっている。"),
    ...
    [BERRY_ID_WIKI] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 15),
            .minYield = YIELD_RATE(2, 1, 3, 3),
            .description1 = COMPOUND_STRING("まわりに ついている イボイボは ポケモンが"),
            .description2 = COMPOUND_STRING("もちやすいように できたと いわれている。"),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_MAGO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 15),
            .minYield = YIELD_RATE(2, 1, 3, 3),
            .description1 = COMPOUND_STRING("おおきく なれば なるほど みが まがる。"),
            .description2 = COMPOUND_STRING("まがるほど あまくて おいしい。"),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_AGUAV] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 15),
            .minYield = YIELD_RATE(2, 1, 3, 3),
            .description1 = COMPOUND_STRING("ちいさい サイズの はなで しかも ひかりを"),
            .description2 = COMPOUND_STRING("ひつようと しない めずらしい きのみ。"),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_IAPAPA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 15),
            .minYield = YIELD_RATE(2, 1, 3, 3),
            .description1 = COMPOUND_STRING("とても おおきな すっぱい きのみ。"),
            .description2 = COMPOUND_STRING("そだてるには みじかくても 1にち かかる。"),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_RAZZ] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("あかい みは たべると ちょっぴり からい。"),
            .description2 = COMPOUND_STRING("そだつのが はやく 4じかんで みを つける。"),
    ...
    [BERRY_ID_BLUK] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 10, 15, 20),
            .minYield = YIELD_RATE(3, 2, 3, 4),
            .description1 = COMPOUND_STRING("そとがわは あおいいろだが たべると"),
            .description2 = COMPOUND_STRING("くちの なかが まっくろに なる。"),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 0,
            .dry = 10,
            .sweet = 10,
    ...
    [BERRY_ID_NANAB] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 10, 15, 20),
            .minYield = YIELD_RATE(3, 2, 3, 4),
            .description1 = COMPOUND_STRING("せかいで 7ばんめに はっけん されたので"),
            .description2 = COMPOUND_STRING("ナナという せつが ゆうりょく。 あまい。"),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_WEPEAR] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 10, 15, 20),
            .minYield = YIELD_RATE(3, 2, 3, 4),
            .description1 = COMPOUND_STRING("ちいさな しろい はなが さく。 にがさと"),
            .description2 = COMPOUND_STRING("すっぱさが まざりあった びみょうな あじ。"),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_PINAP] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 10, 15, 20),
            .minYield = YIELD_RATE(3, 2, 3, 4),
            .description1 = COMPOUND_STRING("かぜに よわく さむさにも よわい。"),
            .description2 = COMPOUND_STRING("みの なかが からく そとがわが すっぱい。"),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_POMEG] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("どんなに みずを あげても えいようが"),
            .description2 = COMPOUND_STRING("あっても 6つの み しか つけない。"),
    ...
    [BERRY_ID_KELPSY] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 5, 20, 26),
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("ねっこの ような かたちの めずらしい"),
            .description2 = COMPOUND_STRING("しゅるい。 とても おおきな はなが さく。"),
            .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_QUALOT] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 5, 20, 26),
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("みずが だいすき。 ずっと あめが ふる"),
            .description2 = COMPOUND_STRING("ばしょでも しっかりと そだつ。"),
            .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
            .spicy = 10,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_HONDEW] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 5, 20, 26),
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("とても こうかで なかなか めに することが"),
            .description2 = COMPOUND_STRING("できない きのみ。 とても おいしい。"),
            .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
            .spicy = 10,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_GREPA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 5, 20, 26),
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("やわらかさと まるい かたちからは"),
            .description2 = COMPOUND_STRING("そうぞうが できないほど すっぱい。"),
            .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 10,
    ...
    [BERRY_ID_TAMATO] =
    {
        .info = {
            ...
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("くちびるが まがって しまうほど からい。"),
            .description2 = COMPOUND_STRING("そだてるにも じかんが かかる。"),
            .growthDuration = GROWTH_DURATION(24, 32, 48, 48, 32, 48),
            .spicy = 20,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_CORNN] =
    {
        .info = {
            ...
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("おおむかしから はえていた。 たくさん"),
            .description2 = COMPOUND_STRING("うえないと みが つかないときも ある。"),
    ...
    [BERRY_ID_MAGOST] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(4, 10, 15, 15),
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("とても あじの バランスが よいと"),
            .description2 = COMPOUND_STRING("ひょうばんの きのみ。"),
            .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 20,
    ...
    [BERRY_ID_RABUTA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(4, 10, 15, 15),
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("たくさんの けが はえている めずらしい"),
            .description2 = COMPOUND_STRING("しゅるい。 かなり にがい。"),
            .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_NOMEL] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(4, 10, 15, 15),
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("かなり すっぱい。 1くち たべると"),
            .description2 = COMPOUND_STRING("3にちかん ほかの あじが しなくなる。"),
            .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_SPELON] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("まっかになった みは とてつもなく からい。"),
            .description2 = COMPOUND_STRING("イボからも からい せいぶんが でている。"),
    ...
    [BERRY_ID_PAMTRE] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("どこからともなく うみを ただよってくる。"),
            .description2 = COMPOUND_STRING("せかいの どこかで そだっている らしい。"),
            .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
            .spicy = 0,
            .dry = 40,
            .sweet = 10,
    ...
    [BERRY_ID_WATMEL] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 15, 15, 15),
            .minYield = YIELD_RATE(1, 2, 3, 3),
            .description1 = COMPOUND_STRING("とても おおきく 50センチを こえるものも"),
            .description2 = COMPOUND_STRING("はっけん された。 ものすごく あまい。"),
            .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 40,
    ...
    [BERRY_ID_DURIN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 15, 15, 15),
            .minYield = YIELD_RATE(1, 3, 3, 3),
            .description1 = COMPOUND_STRING("みただけで にがい。 あまりにも にがいので"),
            .description2 = COMPOUND_STRING("そのままで たべたひとは だれもいない。"),
            .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_BELUE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 15, 15, 15),
            .minYield = YIELD_RATE(1, 2, 3, 3),
            .description1 = COMPOUND_STRING("つるつるとして おいしそうだが とてつもなく"),
            .description2 = COMPOUND_STRING("すっぱい。 そだてるにも じかんが かかる。"),
            .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_OCCA] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("むかしは ねったいちほうで おおく"),
            .description2 = COMPOUND_STRING("とれたという。しゃくねつの からさが じまん。"),
    ...
    [BERRY_ID_PASSHO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("なかには きほうと よばれる くうきの あなが"),
            .description2 = COMPOUND_STRING("いくつも あるので プカプカと みずに うかぶ。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 15,
            .sweet = 0,
    ...
    [BERRY_ID_WACAN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("じめんに おちた かみなりの エネルギーが"),
            .description2 = COMPOUND_STRING("この きのみを おおきく ゆたかに そだてる。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 15,
    ...
    [BERRY_ID_RINDO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("しょくぶつ とくゆうの あおくさい。"),
            .description2 = COMPOUND_STRING("だが せんいしつが おおく からだにいい。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_YACHE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("しぶさと すっぱさが ほどよく ちょうわした"),
            .description2 = COMPOUND_STRING("さわやかな あじ。 ひやすと おいしくなる。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_CHOPLE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("かにくの なかの せいぶんに ねつを"),
            .description2 = COMPOUND_STRING("はっせいする。ひえたこころも ホットになれる。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 15,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_KEBIA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("そとがわは あざやかな みどりいろ。でも"),
            .description2 = COMPOUND_STRING("なかは しぶくて くろい みが ぎっしり。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 15,
            .sweet = 0,
    ...
    [BERRY_ID_SHUCA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("あまみ たっぷりの かにくのなかに かたくて"),
            .description2 = COMPOUND_STRING("こうばしい ふうみが かすかに かんじられる。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 10,
            .dry = 0,
            .sweet = 15,
    ...
    [BERRY_ID_COBA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("とおくにあった べつべつの きのみが かぜで"),
            .description2 = COMPOUND_STRING("はこばれ しんしゅの きのみに なった。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_PAYAPA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("にんげんが ちかづくと せんたんが まるく"),
            .description2 = COMPOUND_STRING("ふくらむので ひとのこころをよむと いわれる。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_TANGA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("せんたんから のびた いとのような かべんを"),
            .description2 = COMPOUND_STRING("かぜで ゆらして むしポケモンを よびよせる。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 20,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_CHARTI] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("しぶみが つよいので ピクルスの ざいりょうに"),
            .description2 = COMPOUND_STRING("なる。そのまま かじっても しげきてき。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 10,
            .dry = 20,
            .sweet = 0,
    ...
    [BERRY_ID_KASIB] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("むかしから ふしぎな ちからが ある。"),
            .description2 = COMPOUND_STRING("かんそうさせて おまもりに することも ある。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 20,
    ...
    [BERRY_ID_HABAN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("たくさん あつめて につめると にがみが"),
            .description2 = COMPOUND_STRING("きえていくので ジャムの ざいりょうにもよい。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_COLBUR] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("ひょうめんに はえた トゲトゲで ポケモンの"),
            .description2 = COMPOUND_STRING("はだに くっつき とおくまで はこばれる。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_BABIRI] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("とてもかたく しげきのつよい あじ。むかしの"),
            .description2 = COMPOUND_STRING("ひとは くすりの ざいりょうに していた。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 25,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_CHILAN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("なかみを くりぬいて かんそうさせ がっきの"),
            .description2 = COMPOUND_STRING("ように ふくと なんともいえない おとがする。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 25,
            .sweet = 10,
    ...
    [BERRY_ID_LIECHI] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("なぞのタネ。 チイラのみには うみの"),
            .description2 = COMPOUND_STRING("ちからが やどるという うわさが ある。"),
    ...
    [BERRY_ID_GANLON] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("なぞのタネ。 リュガのみには りくの"),
            .description2 = COMPOUND_STRING("ちからが やどるという うわさが ある。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 0,
            .dry = 40,
    ...
    [BERRY_ID_SALAC] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("なぞのタネ。 カムラのみには そらの"),
            .description2 = COMPOUND_STRING("ちからが やどるという うわさが ある。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 0,
            .dry = 0,
    ...
    [BERRY_ID_PETAYA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("なぞのタネ。 ヤタピのみには すべての"),
            .description2 = COMPOUND_STRING("いきものの ちからが やどると いわれている。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 40,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_APICOT] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("ふしぎな ふしぎな きのみ。 なにが"),
            .description2 = COMPOUND_STRING("おこるのか なにが できるのか わからない。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 0,
            .dry = 40,
            .sweet = 0,
    ...
    [BERRY_ID_LANSAT] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("でんせつのみ と いわれている。 この みを"),
            .description2 = COMPOUND_STRING("もつと とても しあわせに なるらしい。"),
    ...
    [BERRY_ID_STARF] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 7),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("あまりにも ちからが つよすぎるため"),
            .description2 = COMPOUND_STRING("せかいの はてに すてた まぼろしのみ。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 120, 48, 72),
            .spicy = 10,
            .dry = 10,
            .sweet = 10,
    ...
    [BERRY_ID_ENIGMA] =
    {
        .info = {
            ...
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("しょうたい ふめいの きのみ。"),
            .description2 = COMPOUND_STRING("ほしの ちからを もっている らしい。"),
    ...
    [BERRY_ID_MICLE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 13),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("いっしょに たべたものを あまく"),
            .description2 = COMPOUND_STRING("かんじさせる こうかがある。とてもしぶい。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
            .spicy = 0,
            .dry = 40,
            .sweet = 10,
    ...
    [BERRY_ID_CUSTAP] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 13),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("ひょうめんは かたい かわに つつまれている"),
            .description2 = COMPOUND_STRING("なかみは あまく やわらかい クリームのよう。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
            .spicy = 0,
            .dry = 0,
            .sweet = 40,
    ...
    [BERRY_ID_JABOCA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 13),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("らんぼうに あつかうと みがはじけて"),
            .description2 = COMPOUND_STRING("リズミカルな おとを たてる。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_ROWAP] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 13),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("みを ほぐすと ひとつひとつが コマのような"),
            .description2 = COMPOUND_STRING("かたちをしており むかしは これで あそんだ。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_ROSELI] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("のうこうな あまさのなかに かんじる"),
            .description2 = COMPOUND_STRING("にがみは あじの アクセントに バッチリ。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 25,
    ...
    [BERRY_ID_KEE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("じごくのような からさの あとに"),
            .description2 = COMPOUND_STRING("もうれつな しぶみが おそいかかる。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 30,
            .dry = 30,
            .sweet = 10,
    ...
    {
        .info = {
            .name = _("タラプ"), // "Maranga" is too long
            .firmness = BERRY_FIRMNESS_UNKNOWN,
            .color = OW_BERRY_COLORS == GEN_6_XY ? BERRY_COLOR_BLUE : BERRY_COLOR_YELLOW,
            .size = 0,
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("そとがわは とっても にがいが"),
            .description2 = COMPOUND_STRING("なかは あまくて ジュースのよう。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 10,
            .dry = 10,
            .sweet = 30,
