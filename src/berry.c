...
const struct Berry gBerries[NUM_BERRIES + 1] =
{
    ...
    [BERRY_ID_CHERI] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("{JPN}とても かわいい はなが さく。"),
            .description2 = COMPOUND_STRING("{JPN}まっかな みは とても からい。"),
    ...
    [BERRY_ID_CHESTO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("{JPN}そとの かわの ぶぶんも なかみも すべてが"),
            .description2 = COMPOUND_STRING("{JPN}かたい。 どこを たべても しぶい。"),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_PECHA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("{JPN}とても あまくて おいしい。"),
            .description2 = COMPOUND_STRING("{JPN}やわらかいので はこぶときは ちゅうい。"),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_RAWST] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("{JPN}はっぱの ぶぶんが ながく まるまっていると"),
            .description2 = COMPOUND_STRING("{JPN}みが とても にがく なるらしい。"),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_ASPEAR] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("{JPN}かたい みの なかには すいぶんが とても"),
            .description2 = COMPOUND_STRING("{JPN}おおく ふくまれている。 かなり すっぱい。"),
            .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_LEPPA] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("{JPN}クラボなどに くらべて すこし そだつのが"),
            .description2 = COMPOUND_STRING("{JPN}おそい。 みが ちいさいほど おいしい。"),
    ...
    [BERRY_ID_ORAN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("{JPN}いろいろな あじが まざった ふしぎな み。"),
            .description2 = COMPOUND_STRING("{JPN}みを つけるのに はんにち かかる。"),
    ...
    [BERRY_ID_PERSIM] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 20),
            .minYield = YIELD_RATE(2, 2, 4, 4),
            .description1 = COMPOUND_STRING("{JPN}たいようが だいすき。 ひに あたると"),
            .description2 = COMPOUND_STRING("{JPN}どんどん いろが あざやかに なる。"),
            .growthDuration = GROWTH_DURATION(12, 16, 24, 24, 16, 24),
            .spicy = 10,
            .dry = 10,
            .sweet = 10,
    ...
    [BERRY_ID_LUM] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("{JPN}そだつのに じかんが かかるが たいせつに"),
            .description2 = COMPOUND_STRING("{JPN}そだてると みが 2つ つくことも ある。"),
    ...
    [BERRY_ID_SITRUS] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("{JPN}オレンとは きょうだいの ような そんざい。"),
            .description2 = COMPOUND_STRING("{JPN}おおきくて あじも ととのっている。"),
    ...
    [BERRY_ID_FIGY] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("{JPN}たべられた あとのような かたちの なかには"),
            .description2 = COMPOUND_STRING("{JPN}からい せいぶんが つまっている。"),
    ...
    [BERRY_ID_WIKI] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 15),
            .minYield = YIELD_RATE(2, 1, 3, 3),
            .description1 = COMPOUND_STRING("{JPN}まわりに ついている イボイボは ポケモンが"),
            .description2 = COMPOUND_STRING("{JPN}もちやすいように できたと いわれている。"),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_MAGO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 15),
            .minYield = YIELD_RATE(2, 1, 3, 3),
            .description1 = COMPOUND_STRING("{JPN}おおきく なれば なるほど みが まがる。"),
            .description2 = COMPOUND_STRING("{JPN}まがるほど あまくて おいしい。"),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_AGUAV] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 15),
            .minYield = YIELD_RATE(2, 1, 3, 3),
            .description1 = COMPOUND_STRING("{JPN}ちいさい サイズの はなで しかも ひかりを"),
            .description2 = COMPOUND_STRING("{JPN}ひつようと しない めずらしい きのみ。"),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_IAPAPA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(3, 5, 15, 15),
            .minYield = YIELD_RATE(2, 1, 3, 3),
            .description1 = COMPOUND_STRING("{JPN}とても おおきな すっぱい きのみ。"),
            .description2 = COMPOUND_STRING("{JPN}そだてるには みじかくても 1にち かかる。"),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_RAZZ] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("{JPN}あかい みは たべると ちょっぴり からい。"),
            .description2 = COMPOUND_STRING("{JPN}そだつのが はやく 4じかんで みを つける。"),
    ...
    [BERRY_ID_BLUK] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 10, 15, 20),
            .minYield = YIELD_RATE(3, 2, 3, 4),
            .description1 = COMPOUND_STRING("{JPN}そとがわは あおいいろだが たべると"),
            .description2 = COMPOUND_STRING("{JPN}くちの なかが まっくろに なる。"),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 0,
            .dry = 10,
            .sweet = 10,
    ...
    [BERRY_ID_NANAB] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 10, 15, 20),
            .minYield = YIELD_RATE(3, 2, 3, 4),
            .description1 = COMPOUND_STRING("{JPN}せかいで 7ばんめに はっけん されたので"),
            .description2 = COMPOUND_STRING("{JPN}ナナという せつが ゆうりょく。 あまい。"),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_WEPEAR] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 10, 15, 20),
            .minYield = YIELD_RATE(3, 2, 3, 4),
            .description1 = COMPOUND_STRING("{JPN}ちいさな しろい はなが さく。 にがさと"),
            .description2 = COMPOUND_STRING("{JPN}すっぱさが まざりあった びみょうな あじ。"),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_PINAP] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 10, 15, 20),
            .minYield = YIELD_RATE(3, 2, 3, 4),
            .description1 = COMPOUND_STRING("{JPN}かぜに よわく さむさにも よわい。"),
            .description2 = COMPOUND_STRING("{JPN}みの なかが からく そとがわが すっぱい。"),
            .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_POMEG] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("{JPN}どんなに みずを あげても えいようが"),
            .description2 = COMPOUND_STRING("{JPN}あっても 6つの み しか つけない。"),
    ...
    [BERRY_ID_KELPSY] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 5, 20, 26),
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("{JPN}ねっこの ような かたちの めずらしい"),
            .description2 = COMPOUND_STRING("{JPN}しゅるい。 とても おおきな はなが さく。"),
            .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_QUALOT] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 5, 20, 26),
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("{JPN}みずが だいすき。 ずっと あめが ふる"),
            .description2 = COMPOUND_STRING("{JPN}ばしょでも しっかりと そだつ。"),
            .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
            .spicy = 10,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_HONDEW] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 5, 20, 26),
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("{JPN}とても こうかで なかなか めに することが"),
            .description2 = COMPOUND_STRING("{JPN}できない きのみ。 とても おいしい。"),
            .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
            .spicy = 10,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_GREPA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(6, 5, 20, 26),
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("{JPN}やわらかさと まるい かたちからは"),
            .description2 = COMPOUND_STRING("{JPN}そうぞうが できないほど すっぱい。"),
            .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 10,
    ...
    [BERRY_ID_TAMATO] =
    {
        .info = {
            ...
            .minYield = YIELD_RATE(2, 1, 1, 2),
            .description1 = COMPOUND_STRING("{JPN}くちびるが まがって しまうほど からい。"),
            .description2 = COMPOUND_STRING("{JPN}そだてるにも じかんが かかる。"),
            .growthDuration = GROWTH_DURATION(24, 32, 48, 48, 32, 48),
            .spicy = 20,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_CORNN] =
    {
        .info = {
            ...
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("{JPN}おおむかしから はえていた。 たくさん"),
            .description2 = COMPOUND_STRING("{JPN}うえないと みが つかないときも ある。"),
    ...
    [BERRY_ID_MAGOST] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(4, 10, 15, 15),
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("{JPN}とても あじの バランスが よいと"),
            .description2 = COMPOUND_STRING("{JPN}ひょうばんの きのみ。"),
            .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 20,
    ...
    [BERRY_ID_RABUTA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(4, 10, 15, 15),
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("{JPN}たくさんの けが はえている めずらしい"),
            .description2 = COMPOUND_STRING("{JPN}しゅるい。 かなり にがい。"),
            .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_NOMEL] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(4, 10, 15, 15),
            .minYield = YIELD_RATE(2, 2, 3, 3),
            .description1 = COMPOUND_STRING("{JPN}かなり すっぱい。 1くち たべると"),
            .description2 = COMPOUND_STRING("{JPN}3にちかん ほかの あじが しなくなる。"),
            .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_SPELON] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("{JPN}まっかになった みは とてつもなく からい。"),
            .description2 = COMPOUND_STRING("{JPN}イボからも からい せいぶんが でている。"),
    ...
    [BERRY_ID_PAMTRE] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("{JPN}どこからともなく うみを ただよってくる。"),
            .description2 = COMPOUND_STRING("{JPN}せかいの どこかで そだっている らしい。"),
            .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
            .spicy = 0,
            .dry = 40,
            .sweet = 10,
    ...
    [BERRY_ID_WATMEL] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 15, 15, 15),
            .minYield = YIELD_RATE(1, 2, 3, 3),
            .description1 = COMPOUND_STRING("{JPN}とても おおきく 50センチを こえるものも"),
            .description2 = COMPOUND_STRING("{JPN}はっけん された。 ものすごく あまい。"),
            .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 40,
    ...
    [BERRY_ID_DURIN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 15, 15, 15),
            .minYield = YIELD_RATE(1, 3, 3, 3),
            .description1 = COMPOUND_STRING("{JPN}みただけで にがい。 あまりにも にがいので"),
            .description2 = COMPOUND_STRING("{JPN}そのままで たべたひとは だれもいない。"),
            .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_BELUE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 15, 15, 15),
            .minYield = YIELD_RATE(1, 2, 3, 3),
            .description1 = COMPOUND_STRING("{JPN}つるつるとして おいしそうだが とてつもなく"),
            .description2 = COMPOUND_STRING("{JPN}すっぱい。 そだてるにも じかんが かかる。"),
            .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_OCCA] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("{JPN}むかしは ねったいちほうで おおく"),
            .description2 = COMPOUND_STRING("{JPN}とれたという。しゃくねつの からさが じまん。"),
    ...
    [BERRY_ID_PASSHO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("{JPN}なかには きほうと よばれる くうきの あなが"),
    ...
    [BERRY_ID_RINDO] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("{JPN}しょくぶつ とくゆうの あおくさい。"),
            .description2 = COMPOUND_STRING("{JPN}だが せんいしつが おおく からだにいい。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 10,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_YACHE] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("{JPN}さわやかな あじ。 ひやすと おいしくなる。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_CHOPLE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("{JPN}かにくの なかの せいぶんに ねつを"),
            .description2 = COMPOUND_STRING("{JPN}はっせいする。ひえたこころも ホットになれる。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 15,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_KEBIA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("{JPN}そとがわは あざやかな みどりいろ。でも"),
            .description2 = COMPOUND_STRING("{JPN}なかは しぶくて くろい みが ぎっしり。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 15,
            .sweet = 0,
    ...
    [BERRY_ID_SHUCA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("{JPN}あまみ たっぷりの かにくのなかに かたくて"),
            .description2 = COMPOUND_STRING("{JPN}こうばしい ふうみが かすかに かんじられる。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 10,
            .dry = 0,
            .sweet = 15,
    ...
    [BERRY_ID_COBA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("{JPN}とおくにあった べつべつの きのみが かぜで"),
            .description2 = COMPOUND_STRING("{JPN}はこばれ しんしゅの きのみに なった。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_PAYAPA] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("{JPN}ふくらむので ひとのこころをよむと いわれる。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_CHARTI] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("{JPN}しぶみが つよいので ピクルスの ざいりょうに"),
            .description2 = COMPOUND_STRING("{JPN}なる。そのまま かじっても しげきてき。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 10,
            .dry = 20,
            .sweet = 0,
    ...
    [BERRY_ID_KASIB] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("{JPN}むかしから ふしぎな ちからが ある。"),
    ...
    [BERRY_ID_HABAN] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("{JPN}きえていくので ジャムの ざいりょうにもよい。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 10,
    ...
    [BERRY_ID_COLBUR] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("{JPN}はだに くっつき とおくまで はこばれる。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_BABIRI] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("{JPN}とてもかたく しげきのつよい あじ。むかしの"),
            .description2 = COMPOUND_STRING("{JPN}ひとは くすりの ざいりょうに していた。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 25,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_CHILAN] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("{JPN}なかみを くりぬいて かんそうさせ がっきの"),
            .description2 = COMPOUND_STRING("{JPN}ように ふくと なんともいえない おとがする。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 25,
            .sweet = 10,
    ...
    [BERRY_ID_LIECHI] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("{JPN}なぞのタネ。 チイラのみには うみの"),
            .description2 = COMPOUND_STRING("{JPN}ちからが やどるという うわさが ある。"),
    ...
    [BERRY_ID_GANLON] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("{JPN}なぞのタネ。 リュガのみには りくの"),
            .description2 = COMPOUND_STRING("{JPN}ちからが やどるという うわさが ある。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 0,
            .dry = 40,
    ...
    [BERRY_ID_SALAC] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("{JPN}なぞのタネ。 カムラのみには そらの"),
            .description2 = COMPOUND_STRING("{JPN}ちからが やどるという うわさが ある。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 0,
            .dry = 0,
    ...
    [BERRY_ID_PETAYA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("{JPN}なぞのタネ。 ヤタピのみには すべての"),
            .description2 = COMPOUND_STRING("{JPN}いきものの ちからが やどると いわれている。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 40,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_APICOT] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("{JPN}ふしぎな ふしぎな きのみ。 なにが"),
            .description2 = COMPOUND_STRING("{JPN}おこるのか なにが できるのか わからない。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 0,
            .dry = 40,
            .sweet = 0,
    ...
    [BERRY_ID_LANSAT] =
    {
        .info = {
            ...
            .description1 = COMPOUND_STRING("{JPN}でんせつのみ と いわれている。 この みを"),
            .description2 = COMPOUND_STRING("{JPN}もつと とても しあわせに なるらしい。"),
    ...
    [BERRY_ID_STARF] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("{JPN}せかいの はてに すてた まぼろしのみ。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 120, 48, 72),
            .spicy = 10,
            .dry = 10,
            .sweet = 10,
    ...
    [BERRY_ID_MICLE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 13),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("{JPN}いっしょに たべたものを あまく"),
            .description2 = COMPOUND_STRING("{JPN}かんじさせる こうかがある。とてもしぶい。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
            .spicy = 0,
            .dry = 40,
            .sweet = 10,
    ...
    [BERRY_ID_CUSTAP] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 13),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("{JPN}ひょうめんは かたい かわに つつまれている"),
    ...
    [BERRY_ID_JABOCA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 5, 13),
            .minYield = YIELD_RATE(1, 1, 1, 1),
            .description1 = COMPOUND_STRING("{JPN}らんぼうに あつかうと みがはじけて"),
            .description2 = COMPOUND_STRING("{JPN}リズミカルな おとを たてる。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_ROSELI] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(5, 5, 20, 10),
            .minYield = YIELD_RATE(2, 1, 3, 2),
            .description1 = COMPOUND_STRING("{JPN}のうこうな あまさのなかに かんじる"),
            .description2 = COMPOUND_STRING("{JPN}にがみは あじの アクセントに バッチリ。"),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 25,
    ...
    [BERRY_ID_KEE] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("{JPN}じごくのような からさの あとに"),
            .description2 = COMPOUND_STRING("{JPN}もうれつな しぶみが おそいかかる。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 30,
            .dry = 30,
            .sweet = 10,
    ...
    [BERRY_ID_MARANGA] =
    {
        .info = {
            ...
            .maxYield = YIELD_RATE(2, 5, 10, 13),
            .minYield = YIELD_RATE(1, 1, 1, 2),
            .description1 = COMPOUND_STRING("{JPN}そとがわは とっても にがいが"),
            .description2 = COMPOUND_STRING("{JPN}なかは あまくて ジュースのよう。"),
            .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
            .spicy = 10,
            .dry = 10,
            .sweet = 30,
