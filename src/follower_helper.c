...
static const u8 sCondMsg00[] = _("{STR_VAR_1}は たのしそうに おどった!");
static const u8 sCondMsg01[] = _("{STR_VAR_1}は きれいに おどった!");
static const u8* const sCelebiTexts[] = {sCondMsg00, sCondMsg01, NULL};
static const u8 sCondMsg02[] = _("{STR_VAR_1}は\nほのおを だして きあいを いれた!");
static const u8 sCondMsg03[] = _("{STR_VAR_1}は\nいきおいよく ひを だした!");
static const u8 sCondMsg04[] = _("{STR_VAR_1}は\nボッと ほのおを だした!");
static const u8 sCondMsg05[] = _("{STR_VAR_1}は\nいきおいよく ほのおを だした!");
static const u8* const sFireTexts[] = {sCondMsg02, sCondMsg03, sCondMsg04, sCondMsg05, NULL};
static const u8 sCondMsg06[] = _("{STR_VAR_1}は ポケモンリーグを\nまっすぐ みつめてる");
static const u8 sCondMsg07[] = _("やまの ちょうじょうを ジーッと みつめてる");
static const u8 sCondMsg08[] = _("クンクン! いいにおいが するみたい!");
static const u8 sCondMsg09[] = _("キョロキョロ たなを みまわしてる");
static const u8 sCondMsg10[] = _("{STR_VAR_1}は\nじーっと たなを みつめてる");
static const u8* const sShopTexts[] = {sCondMsg09, sCondMsg10, NULL};
static const u8 sCondMsg11[] = _("{STR_VAR_1}は めを キリッと させた!");
static const u8 sCondMsg12[] = _("{STR_VAR_1}は\nじてんしゃが きになる みたい!");
static const u8 sCondMsg13[] = _("{STR_VAR_1}は きかいを さわりたそう!");
static const u8 sCondMsg14[] = _("{STR_VAR_1}は ふねと\nいっしょに ゆらゆらしてる!");
static const u8 sCondMsg15[] = _("{STR_VAR_1}は\nゆれるふねに あわせて おどってる!");
static const u8 sCondMsg16[] = _("{STR_VAR_1}は まだまだ\nふねから おりたくない みたい");
static const u8* const sBoatTexts[] = {sCondMsg14, sCondMsg15, sCondMsg16, NULL};
static const u8 sCondMsg17[] = _("{STR_VAR_1}は\nきかいの おとを きいてる");
static const u8* const sMachineTexts[] = {sCondMsg13, sCondMsg17, NULL};
static const u8 sCondMsg18[] = _("わ! いきなり みずを かけてきた!");
static const u8 sCondMsg19[] = _("すなを まきあげて あそんでる!");
static const u8 sCondMsg20[] = _("{STR_VAR_1}は おちばを\nいじって あそんでいる");
static const u8 sCondMsg21[] = _("{PLAYER}の あしあとを みて よろこんでる!");
static const u8 sCondMsg22[] = _("{STR_VAR_1}は\nせまくて ドキドキしてる");
static const u8 sCondMsg23[] = _("{STR_VAR_1}は せまくて けいかい してる!");
static const u8* const sElevatorTexts[] = {sCondMsg22, sCondMsg23, NULL};
static const u8 sCondMsg24[] = _("なんだか さむいかぜが ふいてきた!");
static const u8 sCondMsg25[] = _("あやうく すべって ころびそうに なった!");
static const u8 sCondMsg26[] = _("こおりに さわって\nちょっと びっくりした みたい!");
static const u8* const sColdTexts[] = {sCondMsg24, sCondMsg25, sCondMsg26, NULL};
static const u8 sCondMsg27[] = _("はなびらが かおに ついてる!");
static const u8 sCondMsg28[] = _("{STR_VAR_1}は\nちいさく うなっている……");
static const u8 sCondMsg29[] = _("{STR_VAR_1}は\nこわがって プルプルしてる");
static const u8 sCondMsg30[] = _("{STR_VAR_1}は\nなんだか かなしそう……");
static const u8* const sFearTexts[] = {sCondMsg29, sCondMsg30, NULL};
static const u8 sCondMsg31[] = _("{STR_VAR_1}は\nくさむらで あまやどり してる");
static const u8 sCondMsg32[] = _("{STR_VAR_1}は とっても さむそうだ!");
static const u8 sCondMsg33[] = _("{STR_VAR_1}は\nうみを じーっと みつめてる");
static const u8 sCondMsg34[] = _("うみを ジッと みつめてる!");
static const u8 sCondMsg35[] = _("{STR_VAR_1}は\nながれるうみを ジッと みつめてる……");
static const u8* const sSeaTexts[] = {sCondMsg33, sCondMsg34, sCondMsg35, NULL};
static const u8 sCondMsg36[] = _("{STR_VAR_1}は\nたきの おとを きいてる");
static const u8 sCondMsg37[] = _("{STR_VAR_1}は あめで うれしそう!");
static const u8 sCondMsg38[] = _("{STR_VAR_1}は みずに\nうつった かおを じっとみてる……");
static const u8 sCondMsg39[] = _("{STR_VAR_1}は はっぱの\nこすれるおとで リラックス してる……");
static const u8 sCondMsg40[] = _("{STR_VAR_1}は こおりを つっついてる");
static const u8 sCondMsg41[] = _("{STR_VAR_1}は こおりを いじってる");
static const u8* const sIceTexts[] = {sCondMsg26, sCondMsg40, sCondMsg41, NULL};
static const u8 sCondMsg42[] = _("{STR_VAR_1}は やけどが いたそうだ!");
static const u8 sCondMsg43[] = _("{STR_VAR_1}は\nそとを ながめて よろこんでる!");
static const u8 sCondMsg44[] = _("{STR_VAR_1}は\nそらを みあげている");
static const u8* const sDayTexts[] = {sCondMsg43, sCondMsg44, NULL};
static const u8 sCondMsg45[] = _("よぞらを みつめて うっとり してる!");
static const u8 sCondMsg46[] = _("ほしぞらが きれいで うれしい みたい!");
