...
{
    COMPOUND_STRING("こんたいかいの ゆうしょうこうほ ナンバー1!"), // Highest potential
    COMPOUND_STRING("けっしょうまでは かくじつと いわれる チーム。"),
    COMPOUND_STRING("ベスト3に はいる ちからを もった チーム。"),
    COMPOUND_STRING("こんたいかい ゆうしょうこうほの 1チーム。"),
    ...
    COMPOUND_STRING("まず 1しょうが もくひょうと なる チーム。"),
    COMPOUND_STRING("1しょう できれば じょうじょうの チーム。"),
...
static const u8 *const sBattleDomeOpponentStyleTexts[NUM_BATTLE_STYLES] =
{
    ...
    [DOME_BATTLE_STYLE_LOW_PP]          = COMPOUND_STRING("PPの すくない おおわざで しょうぶする。"),
    ...
    [DOME_BATTLE_STYLE_UNUSED1]         = COMPOUND_STRING("ダミーメッセージ1です。"),
    [DOME_BATTLE_STYLE_UNUSED2]         = COMPOUND_STRING("ダミーメッセージ2です。"),
    [DOME_BATTLE_STYLE_UNUSED3]         = COMPOUND_STRING("ダミーメッセージ3です。"),
    [DOME_BATTLE_STYLE_UNUSED4]         = COMPOUND_STRING("ダミーメッセージ4です。"),
};
...
{
    COMPOUND_STRING("HPと こうげきに ちからを いれている。"),              // DOME_TEXT_TWO_GOOD_STATS and DOME_TEXT_HP start here
    COMPOUND_STRING("HPと ぼうぎょに ちからを いれている。"),
    COMPOUND_STRING("HPと すばやさに ちからを いれている。"),
    COMPOUND_STRING("HPと とくこうに ちからを いれている。"),
    COMPOUND_STRING("HPと とくぼうに ちからを いれている。"),
    ...
    COMPOUND_STRING("HPに ちからを いれている。"),                         // DOME_TEXT_ONE_GOOD_STAT starts here
    ...
    COMPOUND_STRING("HPと こうげきに ちからを いれていない!"),                // DOME_TEXT_TWO_BAD_STATS starts here
    COMPOUND_STRING("HPと ぼうぎょに ちからを いれていない!"),
    COMPOUND_STRING("HPと すばやさに ちからを いれていない!"),
    COMPOUND_STRING("HPと とくこうに ちからを いれていない!"),
    COMPOUND_STRING("HPと とくぼうに ちからを いれていない!"),
    ...
    COMPOUND_STRING("HPには ちからを いれていない!"),                           // DOME_TEXT_ONE_BAD_STAT starts here
    ...
    [DOME_TEXT_WELL_BALANCED] = COMPOUND_STRING("バランスよく ポケモンを そだてている。"),
};
...
{
    COMPOUND_STRING(" 1かいせん だい1しあい"),
    COMPOUND_STRING(" 1かいせん だい2しあい"),
    COMPOUND_STRING(" 1かいせん だい3しあい"),
    COMPOUND_STRING(" 1かいせん だい4しあい"),
    COMPOUND_STRING(" 1かいせん だい5しあい"),
    COMPOUND_STRING(" 1かいせん だい6しあい"),
    COMPOUND_STRING(" 1かいせん だい7しあい"),
    COMPOUND_STRING(" 1かいせん だい8しあい"),
    COMPOUND_STRING(" 2かいせん だい1しあい"),
    COMPOUND_STRING(" 2かいせん だい2しあい"),
    COMPOUND_STRING(" 2かいせん だい3しあい"),
    COMPOUND_STRING(" 2かいせん だい4しあい"),
    COMPOUND_STRING("じゅんけっしょう だい1しあい"),
    COMPOUND_STRING("じゅんけっしょう だい2しあい"),
...
static const u8 *const sBattleDomeWinTexts[] =
{
    ...
    [DOME_TEXT_WON_USING_MOVE]   = COMPOUND_STRING("{STR_VAR_2} などで {STR_VAR_1}が しょうり!"),
    [DOME_TEXT_CHAMP_USING_MOVE] = COMPOUND_STRING("{STR_VAR_2} などで {STR_VAR_1} ゆうしょう!"),
    [DOME_TEXT_WON_ON_FORFEIT]   = COMPOUND_STRING("あいての リタイアで {STR_VAR_1}が しょうり!"),
    [DOME_TEXT_CHAMP_ON_FORFEIT] = COMPOUND_STRING("あいての リタイアで {STR_VAR_1} ゆうしょう!"),
    [DOME_TEXT_WON_NO_MOVES]     = COMPOUND_STRING("わざを つかわずに {STR_VAR_1}が しょうり!"),
    [DOME_TEXT_CHAMP_NO_MOVES]   = COMPOUND_STRING("わざを つかわずに {STR_VAR_1} ゆうしょう!"),
};
