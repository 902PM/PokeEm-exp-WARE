const u8 gRibbonDescriptionPart1_Champion[] = _("{JPN}チャンピオンを たおして");
const u8 gRibbonDescriptionPart2_Champion[] = _("{JPN}でんどういり した きねんリボン");
...
const u8 gRibbonDescriptionPart1_Winning[] = _("{JPN}バトルタワー レベル50を");
const u8 gRibbonDescriptionPart2_Winning[] = _("{JPN}かちぬいた きねんのリボン");
const u8 gRibbonDescriptionPart1_Victory[] = _("{JPN}バトルタワー オープンレベルを ");
const u8 gRibbonDescriptionPart2_Victory[] = _("{JPN}かちぬいた きねんのリボン");
const u8 gRibbonDescriptionPart1_Artist[] = _("{JPN}ごうかな にがおえの モデルに");
const u8 gRibbonDescriptionPart2_Artist[] = _("{JPN}なった きねんの リボン");
const u8 gRibbonDescriptionPart1_Effort[] = _("{JPN}たくさん どりょく している");
const u8 gRibbonDescriptionPart2_Effort[] = _("{JPN}ポケモンに おくられる リボン");
