const u8 gGiftRibbonDescriptionPart1_2003RegionalTourney[] = _("{JPN}2003ねん ちほう たいかい");
const u8 gGiftRibbonDescriptionPart2_Champion[] = _("{JPN}ゆうしょう きねんリボン");
const u8 gGiftRibbonDescriptionPart1_2003NationalTourney[] = _("{JPN}2003ねん ぜんこく たいかい");
const u8 gGiftRibbonDescriptionPart1_2003GlobalCup[] = _("{JPN}2003ねん ワールドカップ");
const u8 gGiftRibbonDescriptionPart2_RunnerUp[] = _("{JPN}じゅんゆうしょう きねんリボン");
const u8 gGiftRibbonDescriptionPart2_Semifinalist[] = _("{JPN}ベスト4 きねんリボン");
const u8 gGiftRibbonDescriptionPart1_2004RegionalTourney[] = _("{JPN}2004ねん ちほう たいかい");
const u8 gGiftRibbonDescriptionPart1_2004NationalTourney[] = _("{JPN}2004ねん ぜんこく たいかい");
const u8 gGiftRibbonDescriptionPart1_2004GlobalCup[] = _("{JPN}2004ねん ワールドカップ");
const u8 gGiftRibbonDescriptionPart1_2005RegionalTourney[] = _("{JPN}2005ねん ちほう たいかい");
const u8 gGiftRibbonDescriptionPart1_2005NationalTourney[] = _("{JPN}2005ねん ぜんこく たいかい");
const u8 gGiftRibbonDescriptionPart1_2005GlobalCup[] = _("{JPN}2005ねん ワールドカップ");
const u8 gGiftRibbonDescriptionPart1_PokemonBattleCup[] = _("{JPN}ポケモン バトル カップ");
const u8 gGiftRibbonDescriptionPart2_Participation[] = _("{JPN}さんか きねんリボン");
const u8 gGiftRibbonDescriptionPart1_PokemonLeague[] = _("{JPN}ポケモン リーグ");
const u8 gGiftRibbonDescriptionPart1_AdvanceCup[] = _("{JPN}アドバンス カップ");
const u8 gGiftRibbonDescriptionPart1_PokemonTournament[] = _("{JPN}ポケモンの たいかいに");
const u8 gGiftRibbonDescriptionPart2_Participation2[] = _("{JPN}さんかした きねんリボン");
const u8 gGiftRibbonDescriptionPart1_PokemonEvent[] = _("{JPN}ポケモンの イベントに");
const u8 gGiftRibbonDescriptionPart1_PokemonFestival[] = _("{JPN}ポケモンの おまつりに");
const u8 gGiftRibbonDescriptionPart1_DifficultyClearing[] = _("{JPN}こんなんに うちかった");
const u8 gGiftRibbonDescriptionPart2_Commemorative[] = _("{JPN}きねんリボン");
const u8 gGiftRibbonDescriptionPart1_ClearingAllChallenges[] = _("{JPN}すべての こんなんを");
const u8 gGiftRibbonDescriptionPart2_ClearingAllChallenges[] = _("{JPN}のりこえた きねんリボン");
const u8 gGiftRibbonDescriptionPart1_100StraightWin[] = _("{JPN}100にんぬき たっせい");
const u8 gGiftRibbonDescriptionPart1_DarknessTower[] = _("{JPN}くらやみのとう クリア");
const u8 gGiftRibbonDescriptionPart1_RedTower[] = _("{JPN}くれないのとう クリア");
const u8 gGiftRibbonDescriptionPart1_BlackironTower[] = _("{JPN}くろがねのとう クリア");
const u8 gGiftRibbonDescriptionPart1_FinalTower[] = _("{JPN}さいごのとう クリア");
const u8 gGiftRibbonDescriptionPart1_LegendMaking[] = _("{JPN}でんせつを つくった");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterTokyo[] = _("{JPN}ポケモンセンタートウキョー");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterOsaka[] = _("{JPN}ポケモンセンターオーサカ");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNagoya[] = _("{JPN}ポケモンセンターナゴヤ");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNY[] = _("{JPN}ポケモンセンターニューヨーク");
const u8 gGiftRibbonDescriptionPart1_SummerHolidays[] = _("{JPN}なつやすみ きねんリボン");
const u8 gGiftRibbonDescriptionPart2_EmptyString[] = _("{JPN}");
const u8 gGiftRibbonDescriptionPart1_WinterHolidays[] = _("{JPN}ふゆやすみ きねんリボン");
const u8 gGiftRibbonDescriptionPart1_SpringHolidays[] = _("{JPN}ふゆやすみ きねんリボン");
const u8 gGiftRibbonDescriptionPart1_Evergreen[] = _("{JPN}クリスマス きねんリボン");
const u8 gGiftRibbonDescriptionPart1_SpecialHoliday[] = _("{JPN}きねんび きねんリボン");
const u8 gGiftRibbonDescriptionPart1_HardWorker[] = _("{JPN}がんばった きねんの リボン");
const u8 gGiftRibbonDescriptionPart1_LotsOfFriends[] = _("{JPN}ともだち いっぱい きねんリボン");
const u8 gGiftRibbonDescriptionPart1_FullOfEnergy[] = _("{JPN}げんき いっぱい きねんリボン");
const u8 gGiftRibbonDescriptionPart1_LovedPokemon[] = _("{JPN}だいすきな ポケモンに");
const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("{JPN}つけてあげる きねんリボン");
const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("{JPN}ポケモンが だいすきな ことを");
const u8 gGiftRibbonDescriptionPart2_LoveForPokemon[] = _("{JPN}しょうめいする リボン");
