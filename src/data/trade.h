...
static const u8 sText_IsThisTradeOkay[] = _("{JPN}を こうかんしますか?");
static const u8 sText_Cancel[] = _("{JPN}やめる");
static const u8 sText_ChooseAPkmn[] = _("{JPN}ポケモンを えらんで ください");
static const u8 sText_Summary[] = _("{JPN}つよさをみる");
static const u8 sText_Trade[] = _("{JPN}こうかんにだす");
static const u8 sText_CancelTrade[] = _("{JPN}こうかん を やめますか?");
static const u8 sJPText_PressBButtonToQuit[] = _("{JPN}Bボタン で もどります");
static const u8 sText_Summary2[] = _("{JPN}ステータスをみる");
static const u8 sText_Trade2[] = _("{JPN}こうかんにだす");
static const u8 sText_CommunicationStandby[] = _("{BACKGROUND WHITE}{TEXT_COLORS DARK_GRAY LIGHT_GRAY WHITE}{JPN}つうしんたいきちゅう!\nしばらくおまちください");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{BACKGROUND WHITE}{TEXT_COLORS DARK_GRAY LIGHT_GRAY WHITE}{JPN}こうかんは\nキャンセル されました!");
static const u8 sText_OnlyPkmnForBattle[] = _("{JPN}そのポケモンを こうかんすると\nせんとうできなくなっちゃうよ!");
static const u8 sText_WaitingForYourFriend[] = _("{BACKGROUND WHITE}{TEXT_COLORS DARK_GRAY LIGHT_GRAY WHITE}{JPN}ともだちの しゅうりょうを\nまっています……");
static const u8 sText_YourFriendWantsToTrade[] = _("{JPN}ともだちは ポケモンの\nこうかんを したいようです!");
