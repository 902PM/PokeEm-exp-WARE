...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_TADBULB] =
    {
        ...
        .categoryName = _("でんきおたま"),
        .height = 3,
        .weight = 4,
        .description = COMPOUND_STRING(
            "からだに たくわえた でんりょくで ふゆうする。\nらいうんのときは いつもより\nたかく うきあがるのだ。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KILOWATTREL] =
    {
        ...
        .categoryName = _("ぐんかんどり"),
        .height = 14,
        .weight = 386,
        .description = COMPOUND_STRING(
            "のどぶくろに つばさで つくった でんきを\nためる。 はねの ゆぶんが とても\nすくなく およぎは にがて。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
