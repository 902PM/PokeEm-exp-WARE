...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_ZOROARK_HISUI] =
    {
        ...
        .cryId = CRY_ZOROARK,
        .natDexNum = NATIONAL_DEX_ZOROARK,
        .categoryName = _("のろいぎつね"),
        .height = 16,
        .weight = 730,
        .description = COMPOUND_STRING(
            "はくはつ ふりみだしすがた しにがみのごとく。\nわがみをも きりさく はげしきおんしゅうにて\nあだ おそい みちづれかくごで しとめたり。"),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_GALVANTULA] =
    {
        ...
        .categoryName = _("でんきグモ"),
        .height = 8,
        .weight = 143,
        .description = COMPOUND_STRING(
            "てきに おそわれると でんきを おびびた\nいとを たくさん はきだして\nでんきの バリアを つくる。"),
        .pokemonScale = 366,
        .pokemonOffset = 10,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_CRYOGONAL] =
    {
        ...
        .categoryName = _("けっしょう"),
        .height = 11,
        .weight = 1480,
        .description = COMPOUND_STRING(
            "たいおんが あがると すいじょうきに なって\nすがたを けす。たいおんが さがると\nもとの こおりに もどる。"),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
