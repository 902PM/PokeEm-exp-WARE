...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .categoryName = _("クライミング"),
        .height = 13,
        .weight = 430,
        .description = COMPOUND_STRING(
            "たしゅ あっとうする しんたいのうりょくと もうどく ゆうし\nかんれいなる こうちにおいては てきなし。\nむれなさず たんどくをよしとする せいしつ。"),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
