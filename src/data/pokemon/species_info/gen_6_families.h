...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_CLAUNCHER] =
    {
        ...
        .categoryName = _("みずでっぽう"),
        .height = 5,
        .weight = 83,
        .description = COMPOUND_STRING(
            "おおきな ハサミから あっしゅくした みずを\nピストルのように うちだし\nとんでいる えものを うちおとす。"),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GOODRA_HISUI] =
    {
        ...
        .cryId = CRY_GOODRA,
        .natDexNum = NATIONAL_DEX_GOODRA,
        .categoryName = _("からこもり"),
        .height = 17,
        .weight = 3341,
        .description = COMPOUND_STRING(
            "きんぞくのからの ごうじゅうを じざいに あやつる。\nこどくを いとい しゅうねんぶかく すいたものが\nおのれから はなれると いかり あらぶる。"),
        .pokemonScale = 261,
        .pokemonOffset = 1,
        .trainerScale = 334,
        .trainerOffset = 4,
    ...
    [SPECIES_AVALUGG] =
    {
        ...
        .categoryName = _("ひょうざん"),
        .height = 20,
        .weight = 5050,
        .description = COMPOUND_STRING(
            "こおりついた からだは こうてつのように\nかたい。 たちふさがる ものを\nきょたいで おしつぶし いどうする。"),
        .pokemonScale = 261,
        .pokemonOffset = 1,
        .trainerScale = 334,
        .trainerOffset = 4,
