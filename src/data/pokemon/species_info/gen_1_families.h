...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_ANNIHILAPE] =
    {
        ...
        .categoryName = _("ふんどざる"),
        .height = 12,
        .weight = 560,
        .description = COMPOUND_STRING(
            "いかりのボルテージが りんかいてんを こえたとき\nにくたいという わくに しばられない\nパワーを てにいれた。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
    ...
    [SPECIES_SYLVEON] =
    {
        ...
        .categoryName = _("むすびつき"),
        .height = 10,
        .weight = 235,
        .description = COMPOUND_STRING(
            "リボンのような しょっかくから きもちを\nやわらげる はどうを おくりこみ\nたたかいを やめさせる。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
