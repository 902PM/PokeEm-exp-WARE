...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_BANETTE] =
    {
        ...
        .categoryName = _("ぬいぐるみ"),
        .height = 11,
        .weight = 125,
        .description = COMPOUND_STRING(
            "すてられた ぬいぐるみが ポケモンに なった。\nゴミすてばを すみかにして すてた こどもを\nさがして あるきまわると いわれている。"),
        .pokemonScale = 262,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
