...
{
    {.request = COMPOUND_STRING("すべすべ"), .acceptedItems = sFavorLadyAcceptedItems_Slippery, .prize = ITEM_BEAST_BALL},
    {.request = COMPOUND_STRING("まるまる"), .acceptedItems = sFavorLadyAcceptedItems_Roundish, .prize = ITEM_BIG_NUGGET},
    {.request = COMPOUND_STRING("バキバキ"), .acceptedItems = sFavorLadyAcceptedItems_Whamish,  .prize = ITEM_EXP_CANDY_XL},
    {.request = COMPOUND_STRING("ピカピカ"),    .acceptedItems = sFavorLadyAcceptedItems_Shiny,    .prize = ITEM_ABILITY_PATCH},
    {.request = COMPOUND_STRING("ねばねば"),   .acceptedItems = sFavorLadyAcceptedItems_Sticky,   .prize = ITEM_RARE_CANDY},
    {.request = COMPOUND_STRING("ちくちく"),   .acceptedItems = sFavorLadyAcceptedItems_Pointy,   .prize = ITEM_PP_MAX},
};
