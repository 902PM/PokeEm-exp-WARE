...
static const u8 sCreditsText_PackageAndManual[]               = _("パッケージ デザイン");
static const u8 sCreditsText_EnglishVersion[]                 = _("{ENG}English Version Coordinators");
static const u8 sCreditsText_Translator[]                     = _("ローカライズ");
static const u8 sCreditsText_TextEditor[]                     = _("テキスト");
static const u8 sCreditsText_NCLCoordinator[]                 = _("{ENG}NCL Coordinator");
static const u8 sCreditsText_GraphicDesigner[]                = _("グラフィック デザイン");
static const u8 sCreditsText_NOAProductTesting[]              = _("デバッグ");
static const u8 sCreditsText_HideyukiNakajima[]               = _("ひでゆき なかじま");
static const u8 sCreditsText_HidenoriSaeki[]                  = _("さえき ひでのり");
static const u8 sCreditsText_YokoWatanabe[]                   = _("わたなべ ようこ");
static const u8 sCreditsText_SakaeKimura[]                    = _("きむら さたけ");
static const u8 sCreditsText_ChiakiShinkai[]                  = _("しんかい ちあき");
static const u8 sCreditsText_SethMcMahill[]                   = _("{ENG}Seth McMahill");
static const u8 sCreditsText_NobOgasawara[]                   = _("おがさわら のぶ");
static const u8 sCreditsText_TeresaLillygren[]                = _("{ENG}Teresa Lillygren");
static const u8 sCreditsText_KimikoNakamichi[]                = _("なかみち きみこ");
static const u8 sCreditsText_SouichiYamamoto[]                = _("やまもと そういち");
static const u8 sCreditsText_YuichiroIto[]                    = _("いとう ゆういちろう");
static const u8 sCreditsText_ThomasHertzog[]                  = _("{ENG}Thomas Hertzog");
static const u8 sCreditsText_MikaKurosawa[]                   = _("くろさわ みか");
static const u8 sCreditsText_NationalFederationBlind[]        = _("{ENG}National Federation of the Blind");
static const u8 sCreditsText_PatriciaAMaurer[]                = _("{ENG}Patricia A. Maurer");
static const u8 sCreditsText_EuropeanBlindUnion[]             = _("{ENG}European Blind Union");
static const u8 sCreditsText_AustralianBrailleAuthority[]     = _("{ENG}Australian Braille Authority");
static const u8 sCreditsText_RoyalNewZealandFederationBlind[] = _("{ENG}Royal New Zealand Federation for the Blind");
static const u8 sCreditsText_MotoyasuTojima[]                 = _("とじま もとやす");
static const u8 sCreditsText_NicolaPrattBarlow[]              = _("{ENG}Nicola Pratt-Barlow");
static const u8 sCreditsText_ShellieDow[]                     = _("{ENG}Shellie Dow");
static const u8 sCreditsText_ErikJohnson[]                    = _("{ENG}Erik Johnson");
