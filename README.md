...
１５．バトルピラミッドが相手だけ全ギミック使えて、こちらが一切ギミック使えない理不尽の押し付け施設になったので、まず金ジンダイを４世代と同じ７周に下方修正。（以降、５周ごとに金ジンダイなのは変わらず）<br>
１６．さらに、ピラミッドに落ちているアイテムを整備。けむりだまをドロップテーブルに入れて、野生が超簡単に。<br>
...
<br>→バトルドームでトライアスリート（ランニング）Fがエレキフィールド貼ってくるのを確認。
...
<br>→ちなみに、メガストーンがないけど、バッグに必要アイテムがなにもないので、何一つとしてギミックの使用ができない
<br>→とりあえず、ダイマックスここだけ解禁（なおダイマレベル）して、理不尽を少なくする。
<br>→メガはさらにアイテムが必要、Zワザもそう。テラはチャージ回復しないとだから１周で１回しかできない。
...
- バトルタワー等のKP
→トレーナープール改変中。元々のデータの関係で変なポケモンが紛れ込んでる。<br>
