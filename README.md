...
- Zワザ『-』問題はほぼ解決？そもの話、フォーク元から欠陥があった模様。
<br>→要経過観察だが、今のところ専用Zワザと通常技を使い分けできている。

- フロンティアのポケモンプールはもう一考という感じ。
<br>→あまりにも同じポケモンが出すぎている。1～4まで型を持つポケモンは仕様上なのか、登場率が多い。
...
<br>→今のところ、バトルタワーではアホムーブかまさなくなったので、↑のせいかも。
